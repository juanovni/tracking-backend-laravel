...
!function(t, e) {
    ...
    "use strict";
    function e(t) {
        for (var e, i, o = 1, n = arguments.length; o < n; o++)
            for (e in i = arguments[o])
                t[e] = i[e];
        return t
    }
    ...
    function o() {}
    function n(t, e) {
        var i, o = Array.prototype.slice;
        return t.bind ? t.bind.apply(t, o.call(arguments, 1)) : (i = o.call(arguments, 2),
        function() {
            return t.apply(e, i.length ? i.concat(o.call(arguments)) : arguments)
        }
        )
    }
    var s = 0;
    ...
    function p(t, e) {
        for (var o in Object.prototype.hasOwnProperty.call(t, "options") || (t.options = t.options ? i(t.options) : {}),
        e)
            t.options[o] = e[o];
        return t.options
    }
    ...
    A.extend = function(t) {
        ...
        var n, s = o.__super__ = this.prototype, r = i(s);
        for (n in (r.constructor = o).prototype = r,
        this)
            Object.prototype.hasOwnProperty.call(this, n) && "prototype" !== n && "__super__" !== n && (o[n] = this[n]);
        if (t.statics && e(o, t.statics),
        t.includes) {
            var a = t.includes;
        ...
        off: function(t, e, i) {
            if (arguments.length)
                if ("object" == typeof t)
                    ...
                    t = d(t);
                    for (var n = 1 === arguments.length, s = 0, r = t.length; s < r; s++)
        ...
        _off: function(t, e, i) {
            ...
            if (this._events && (o = this._events[t]))
                if (1 === arguments.length) {
                    ...
                    "function" != typeof e ? console.warn("wrong listener type: " + typeof e) : !1 !== (e = this._listens(t, e, i)) && (i = o[e],
        ...
        listens: function(t, e, i, o) {
            ...
            if (o)
                for (var r in this._eventParents)
                    if (this._eventParents[r].listens(t, e, i, o))
                        return !0;
            return !1
        },
    ...
    Z.prototype = {
        ...
        contains: function(t) {
            var e, i;
            return (t = ("number" == typeof t[0] || t instanceof k ? O : B)(t))instanceof Z ? (e = t.min,
            i = t.max) : e = i = t,
        ...
        pad: function(t) {
            ...
            return B(O(e.x - o, e.y - t), O(i.x + o, i.y + t))
        },
        equals: function(t) {
            return !!t && (t = B(t),
    ...
    R.prototype = {
        extend: function(t) {
            ...
            n.lng = Math.max(i.lng, n.lng)) : (this._southWest = new F(e.lat,e.lng),
        ...
        pad: function(t) {
            ...
            return new R(new F(e.lat - o,e.lng - t),new F(i.lat + o,i.lng + t))
        },
        getCenter: function() {
        ...
        intersects: function(t) {
            ...
            var e = this._southWest
              , i = this._northEast
              , o = t.getSouthWest()
              , n = (t = t.getNorthEast()).lat >= e.lat && o.lat <= i.lat;
    ...
    var U = {
        ...
        wrapLatLngBounds: function(t) {
            var e = t.getCenter()
              ...
              , o = e.lat - i.lat;
            e = e.lng - i.lng;
            return 0 == o && 0 == e ? t : (i = t.getSouthWest(),
            t = t.getNorthEast(),
            new R(new F(i.lat - o,i.lng - e),new F(t.lat - o,t.lng - e)))
        }
    }
      , j = e({}, U, {
        wrapLng: [-180, 180],
        ...
        distance: function(t, e) {
            ...
            t = s * s + Math.cos(o) * Math.cos(n) * e * e,
    ...
    var H = e({}, j, {
        code: "EPSG:3857",
        projection: G,
        transformation: W(H = .5 / (Math.PI * G.R), .5, -H, .5)
    })
      , $ = e({}, H, {
        code: "EPSG:900913"
    });
    ...
    function K(t, e) {
        for (var i, o, n, s, r = "", a = 0, h = t.length; a < h; a++) {
            for (i = 0,
            o = (n = t[a]).length; i < o; i++)
                r += (i ? "L" : "M") + (s = n[i]).x + " " + s.y;
            r += e ? Mt.svg ? "z" : "x" : ""
        }
        return r || "M0 0"
    ...
    var J = document.documentElement.style
      ...
      , nt = (ot = et && Ct("Google") && ot < 537 && !("AudioNode"in window),
    !!window.opera)
      , st = !X && Ct("chrome")
      , rt = Ct("gecko") && !tt && !nt && !Y
      , at = !st && Ct("safari")
      ...
      , ct = Y && "transition"in J
      , dt = "WebKitCSSMatrix"in window && "m11"in new window.WebKitCSSMatrix && !it
      , pt = (J = "MozPerspective"in J,
    !window.L_DISABLE_3D && (ct || dt || J) && !lt && !ht)
      , _t = ($i = "undefined" != typeof orientation || Ct("mobile")) && tt
      , mt = $i && dt
      ...
      , Tt = !(!document.createElementNS || !V("svg").createSVGRect)
      , St = !!Tt && ((St = document.createElement("div")).innerHTML = "<svg/>",
    ...
    var Ut = 200;
    var jt, Gt, qt, Wt, Ht, $t, Vt = ue(["transform", "webkitTransform", "OTransform", "MozTransform", "msTransform"]), Kt = ue(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]), Jt = "webkitTransition" === Kt || "OTransition" === Kt ? Kt + "End" : "transitionend";
    function Yt(t) {
    ...
    function ne(t, e) {
        return void 0 !== t.classList ? t.classList.contains(e) : 0 < (t = he(t)).length && new RegExp("(^|\\s)" + e + "(\\s|$)").test(t)
    }
    function se(t, e) {
        var i;
        if (void 0 !== t.classList)
            for (var o = d(e), n = 0, s = o.length; n < s; n++)
                t.classList.add(o[n]);
        else
            ne(t, e) || ae(t, ((i = he(t)) ? i + " " : "") + e)
    }
    function re(t, e) {
        void 0 !== t.classList ? t.classList.remove(e) : ae(t, c((" " + he(t) + " ").replace(" " + e + " ", " ")))
    }
    function ae(t, e) {
    ...
    function ce(t, e, i) {
        e = e || new k(0,0),
        t.style[Vt] = (Mt.ie3d ? "translate(" + e.x + "px," + e.y + "px)" : "translate3d(" + e.x + "px," + e.y + "px,0)") + (i ? " scale(" + i + ")" : "")
    }
    function de(t, e) {
        t._leaflet_pos = e,
        Mt.any3d ? ce(t, e) : (t.style.left = e.x + "px",
        t.style.top = e.y + "px")
    }
    function pe(t) {
    ...
    function fe(t) {
        for (; -1 === t.tabIndex; )
            t = t.parentNode;
        t.style && (ge(),
        $t = (Ht = t).style.outlineStyle,
        t.style.outlineStyle = "none",
        xe(window, "keydown", ge))
    }
    function ge() {
        Ht && (Ht.style.outlineStyle = $t,
        $t = Ht = void 0,
    ...
    Wt = "onselectstart"in document ? (qt = function() {
    ...
    ) : (Gt = ue(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]),
    qt = function() {
        var t;
        Gt && (t = document.documentElement.style,
        jt = t[Gt],
        t[Gt] = "none")
    }
    ,
    function() {
        Gt && (document.documentElement.style[Gt] = jt,
        jt = void 0)
    }
    ),
    Y = {
    ...
    function Te(t, e, i, o) {
        var n, s, a = e + r(i) + (o ? "_" + r(o) : "");
        t[be] && t[be][a] || (s = n = function(e) {
            return i.call(o || t, e || window.event)
        }
        ,
        !Mt.touchNative && Mt.pointer && 0 === e.indexOf("touch") ? n = function(t, e, i) {
            return "touchstart" !== e || Bt || (document.addEventListener(At, Rt, !0),
            document.addEventListener(zt, Dt, !0),
            document.addEventListener(It, Ft, !0),
            document.addEventListener(kt, Ft, !0),
            Bt = !0),
            Ot[e] ? (i = Ot[e].bind(this, i),
            t.addEventListener(Et[e], i, !1),
            i) : (console.warn("wrong event specified:", e),
            l)
        }(t, e, n) : Mt.touch && "dblclick" === e ? n = function(t, e) {
            t.addEventListener("dblclick", e);
            var i, o = 0;
            function n(t) {
                var n;
                1 !== t.detail ? i = t.detail : "mouse" === t.pointerType || t.sourceCapabilities && !t.sourceCapabilities.firesTouchEvents || (n = ke(t)).some((function(t) {
                    return t instanceof HTMLLabelElement && t.attributes.for
                }
                )) && !n.some((function(t) {
                    return t instanceof HTMLInputElement || t instanceof HTMLSelectElement
                }
                )) || ((n = Date.now()) - o <= Ut ? 2 == ++i && e(function(t) {
                    var e, i, o = {};
                    for (i in t)
                        e = t[i],
                        o[i] = e && e.bind ? e.bind(t) : e;
                    return (t = o).type = "dblclick",
                    o.detail = 2,
                    o.isTrusted = !1,
                    o._simulated = !0,
                    o
        ...
        }(t, n) : "addEventListener"in t ? "touchstart" === e || "touchmove" === e || "wheel" === e || "mousewheel" === e ? t.addEventListener(Pe[e] || e, n, !!Mt.passiveEvents && {
            passive: !1
        }) : "mouseenter" === e || "mouseleave" === e ? t.addEventListener(Pe[e], n = function(e) {
            e = e || window.event,
            Be(t, e) && s(e)
        }
        , !1) : t.addEventListener(e, s, !1) : t.attachEvent("on" + e, n),
        t[be] = t[be] || {},
        t[be][a] = n)
    }
    function Se(t, e, i, o, n) {
        var s, a;
        n = n || e + r(i) + (o ? "_" + r(o) : ""),
        (i = t[be] && t[be][n]) && (!Mt.touchNative && Mt.pointer && 0 === e.indexOf("touch") ? (o = t,
        a = i,
        Et[s = e] ? o.removeEventListener(Et[s], a, !1) : console.warn("wrong event specified:", s)) : Mt.touch && "dblclick" === e ? (o = i,
        (a = t).removeEventListener("dblclick", o.dblclick),
        a.removeEventListener("click", o.simDblclick)) : "removeEventListener"in t ? t.removeEventListener(Pe[e] || e, i, !1) : t.detachEvent("on" + e, i),
        t[be][n] = null)
    }
    function Ce(t) {
    ...
    function Me(t) {
        return Te(t, "wheel", Ce),
        this
    }
    function Ae(t) {
        return xe(t, "mousedown touchstart dblclick contextmenu", Ce),
    ...
    function Ee(t, e) {
        var i, o;
        return e ? (o = (i = ve(e)).boundingClientRect,
        new k((t.clientX - o.left) / i.x - e.clientLeft,(t.clientY - o.top) / i.y - e.clientTop)) : new k(t.clientX,t.clientY)
    }
    var Oe = Mt.linux && Mt.chrome ? window.devicePixelRatio : Mt.mac ? 3 * window.devicePixelRatio : 0 < window.devicePixelRatio ? 2 * window.devicePixelRatio : 1;
    function Ze(t) {
        return Mt.edge ? t.wheelDeltaY / 2 : t.deltaY && 0 === t.deltaMode ? -t.deltaY / Oe : t.deltaY && 1 === t.deltaMode ? 20 * -t.deltaY : t.deltaY && 2 === t.deltaMode ? 60 * -t.deltaY : t.deltaX || t.deltaZ ? 0 : t.wheelDelta ? (t.wheelDeltaY || t.wheelDelta) / 2 : t.detail && Math.abs(t.detail) < 32765 ? 20 * -t.detail : t.detail ? t.detail / -32765 * 60 : 0
    }
    function Be(t, e) {
    ...
    var Re = I.extend({
      ...
      , De = I.extend({
        ...
        initialize: function(t, e) {
            ...
            xe(this._proxy, Jt, this._catchTransitionEnd, this)),
        ...
        setView: function(t, i, o) {
            ...
            o = o || {},
            this._stop(),
            this._loaded && !o.reset && !0 !== o && (void 0 !== o.animate && (o.zoom = e({
                animate: o.animate
            }, o.zoom),
            o.pan = e({
                animate: o.animate,
            ...
            this._zoom !== i ? this._tryAnimatedZoom && this._tryAnimatedZoom(t, i, o.zoom) : this._tryAnimatedPan(t, o.pan)) ? (clearTimeout(this._sizeTimer),
            this) : (this._resetView(t, i, o.pan && o.pan.noMoveStart),
            this)
        },
        ...
        zoomIn: function(t, e) {
            return t = t || (Mt.any3d ? this.options.zoomDelta : 1),
        ...
        setZoomAround: function(t, e, i) {
            ...
            t = (t instanceof k ? t : this.latLngToContainerPoint(t)).subtract(n).multiplyBy(1 - 1 / o),
            o = this.containerPointToLatLng(n.add(t));
        ...
        _getBoundsCenterZoom: function(t, e) {
            ...
            var i = O(e.paddingTopLeft || e.padding || [0, 0])
              , o = O(e.paddingBottomRight || e.padding || [0, 0])
              , n = this.getBoundsZoom(t, !1, i.add(o));
            return (n = "number" == typeof e.maxZoom ? Math.min(e.maxZoom, n) : n) === 1 / 0 ? {
                center: t.getCenter(),
                zoom: n
            } : (e = o.subtract(i).divideBy(2),
            o = this.project(t.getSouthWest(), n),
            i = this.project(t.getNorthEast(), n),
            {
                center: this.unproject(o.add(i).divideBy(2).add(e), n),
                zoom: n
            })
        },
        ...
        panBy: function(t, e) {
            ...
            !1 !== e.animate ? (se(this._mapPane, "leaflet-pan-anim"),
        ...
        flyTo: function(t, e, i) {
            ...
            function i() {
                ...
                s <= 1 ? (this._flyToFrame = S(i, this),
                this._move(this.unproject(o.add(n.subtract(o).multiplyBy(function(t) {
        ...
        panInside: function(t, e) {
            var i = O((e = e || {}).paddingTopLeft || e.padding || [0, 0])
              ...
              , s = (t = this.project(t),
            (i = B([(s = this.getPixelBounds()).min.add(i), s.max.subtract(o)])).getSize());
        ...
        _handleGeolocationResponse: function(t) {
            if (this._container._leaflet_id) {
                var e, i, o = new F(t.coords.latitude,t.coords.longitude), n = o.toBounds(2 * t.coords.accuracy), s = this._locateOptions, r = (s.setView && (e = this.getBoundsZoom(n),
                this.setView(o, s.maxZoom ? Math.min(e, s.maxZoom) : e)),
                {
                    latlng: o,
                    bounds: n,
        ...
        createPane: function(t, e) {
            return e = Xt("div", "leaflet-pane" + (t ? " leaflet-" + t.replace("Pane", "") + "-pane" : ""), e || this._mapPane),
            t && (this._panes[t] = e),
            e
        },
        getCenter: function() {
        ...
        layerPointToLatLng: function(t) {
            return t = O(t).add(this.getPixelOrigin()),
            this.unproject(t)
        },
        ...
        containerPointToLatLng: function(t) {
            return t = this.containerPointToLayerPoint(O(t)),
        ...
        _initContainer: function(t) {
            ...
            xe(t, "scroll", this._onScroll, this),
            this._containerId = r(t)
        },
        _initLayout: function() {
            var t = this._container
              , e = (this._fadeAnimated = this.options.fadeAnimation && Mt.any3d,
            se(t, "leaflet-container" + (Mt.touch ? " leaflet-touch" : "") + (Mt.retina ? " leaflet-retina" : "") + (Mt.ielt9 ? " leaflet-oldie" : "") + (Mt.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : "")),
            Qt(t, "position"));
        ...
        _initPanes: function() {
            ...
            this.options.markerZoomAnimation || (se(t.markerPane, "leaflet-zoom-hide"),
        ...
        _findEventTargets: function(t, e) {
            for (var i, o = [], n = "mouseout" === e || "mouseover" === e, s = t.target || t.srcElement, a = !1; s; ) {
            ...
            return o.length || a || n || !this.listens(e, !0) ? o : [this]
        },
        ...
        _handleDOMEvent: function(t) {
            ...
            !this._loaded || i._leaflet_disable_events || "click" === t.type && this._isClickDisabled(i) || ("mousedown" === (e = t.type) && fe(i),
            this._fireDOMEvent(t, e))
        },
        _mouseEvents: ["click", "dblclick", "mouseover", "mouseout", "contextmenu"],
        _fireDOMEvent: function(t, i, o) {
            "click" === t.type && ((h = e({}, t)).type = "preclick",
            this._fireDOMEvent(h, h.type, o));
            var n = this._findEventTargets(t, i);
            if (o) {
                for (var s = [], r = 0; r < o.length; r++)
                    o[r].listens(i, !0) && s.push(o[r]);
                n = s.concat(n)
            }
            if (n.length) {
                "contextmenu" === i && ze(t);
                ...
                r = 0; r < n.length; r++)
                    if (n[r].fire(i, l, !0),
                    l.originalEvent._stopped || !1 === n[r].options.bubblingMouseEvents && -1 !== y(this._mouseEvents, i))
                        return
            }
        },
        ...
        _latLngBoundsToNewLayerBounds: function(t, e, i) {
            return i = this._getNewPixelOrigin(i, e),
            B([this.project(t.getSouthWest(), e)._subtract(i), this.project(t.getNorthWest(), e)._subtract(i), this.project(t.getSouthEast(), e)._subtract(i), this.project(t.getNorthEast(), e)._subtract(i)])
        },
        ...
        _limitCenter: function(t, e, i) {
            var o, n;
            return !i || (o = this.project(t, e),
            n = this.getSize().divideBy(2),
            n = new Z(o.subtract(n),o.add(n)),
            n = this._getBoundsOffset(n, i, e),
            Math.abs(n.x) <= 1 && Math.abs(n.y) <= 1) ? t : this.unproject(o.add(n), e)
        },
        _limitOffset: function(t, e) {
            var i;
            return e ? (i = new Z((i = this.getPixelBounds()).min.add(t),i.max.add(t)),
            t.add(this._getBoundsOffset(i, e))) : t
        },
        _getBoundsOffset: function(t, e, i) {
            return i = (e = B(this.project(e.getNorthEast(), i), this.project(e.getSouthWest(), i))).min.subtract(t.min),
        ...
        _limitZoom: function(t) {
            var e = this.getMinZoom()
              , i = this.getMaxZoom()
              , o = Mt.any3d ? this.options.zoomSnap : 1;
        ...
        _createAnimProxy: function() {
            ...
            this.on("zoomanim", (function(t) {
                ...
                ce(this._proxy, this.project(t.center, t.zoom), this.getZoomScale(t.zoom, 1)),
        ...
        _tryAnimatedZoom: function(t, e, i) {
            if (!this._animatingZoom) {
                ...
                if (!0 !== i.animate && !this.getSize().contains(o))
                    return !1;
                S((function() {
        ...
        _onZoomTransitionEnd: function() {
            this._animatingZoom && (this._mapPane && re(this._mapPane, "leaflet-zoom-anim"),
    ...
    Ne.extend({
        ...
        addTo: function(t) {
            return Ne.prototype.addTo.call(this, t),
        ...
        expand: function() {
            ...
            return t < this._section.clientHeight ? (se(this._section, "leaflet-control-layers-scrollbar"),
            this._section.style.height = t + "px") : re(this._section, "leaflet-control-layers-scrollbar"),
            this._checkDisabledLayers(),
            this
        },
        collapse: function() {
            return re(this._container, "leaflet-control-layers-expanded"),
            this
        },
        _initLayout: function() {
            var t = "leaflet-control-layers"
              ...
              , o = (e.setAttribute("aria-haspopup", !0),
            Ae(e),
            Me(e),
            this._section = Xt("section", t + "-list"))
              , n = (i && (this._map.on("click", this.collapse, this),
            xe(e, {
            ...
            i || this.expand(),
            this._baseLayersList = Xt("div", t + "-base", o),
            this._separator = Xt("div", t + "-separator", o),
            this._overlaysList = Xt("div", t + "-overlays", o),
            e.appendChild(o)
        },
        ...
        _update: function() {
            if (this._container) {
                ...
                this._layerControlInputs = [];
                for (var t, e, i, o = 0, n = 0; n < this._layers.length; n++)
                    i = this._layers[n],
                    this._addItem(i),
                    e = e || i.overlay,
                    t = t || !i.overlay,
                    o += i.overlay ? 0 : 1;
                this.options.hideSingleBase && (this._baseLayersList.style.display = (t = t && 1 < o) ? "" : "none"),
        ...
        _addItem: function(t) {
            var e, i = document.createElement("label"), o = this._map.hasLayer(t.layer), n = ((o = (t.overlay ? ((e = document.createElement("input")).type = "checkbox",
            e.className = "leaflet-control-layers-selector",
            e.defaultChecked = o) : e = this._createRadioElement("leaflet-base-layers_" + r(this), o),
        ...
        _checkDisabledLayers: function() {
            for (var t, e, i = this._layerControlInputs, o = this._map.getZoom(), n = i.length - 1; 0 <= n; n--)
                t = i[n],
                e = this._getLayer(t.layerId).layer,
    ...
    Ne.extend({
      ...
      , qe = Ne.extend({
        options: {
            ...
            prefix: '<a href="https://leafletjs.com" title="A JavaScript library for interactive maps">' + (Mt.inlineSvg ? '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg> ' : "") + "Leaflet</a>"
        },
        initialize: function(t) {
            p(this, t),
            this._attributions = {}
    ...
    Mt.touch ? "touchstart mousedown" : "mousedown")
      , He = I.extend({
        ...
        enable: function() {
            this._enabled || (xe(this._dragStartTarget, We, this._onDown, this),
            this._enabled = !0)
        },
        disable: function() {
            this._enabled && (He._dragging === this && this.finishDrag(!0),
        ...
        _onDown: function(t) {
            ...
            ne(this._element, "leaflet-zoom-anim") || (t.touches && 1 !== t.touches.length ? He._dragging === this && this.finishDrag() : He._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || ((He._dragging = this)._preventOutline && fe(this._element),
            _e(),
            qt(),
            ...
            i = "mousedown" === t.type,
            xe(document, i ? "mousemove" : "touchmove", this._onMove, this),
            xe(document, i ? "mouseup" : "touchend touchcancel", this._onUp, this)))))
        },
        _onMove: function(t) {
            var e;
        ...
        finishDrag: function(t) {
            ...
            this._lastTarget && (re(this._lastTarget, "leaflet-drag-target"),
    ...
    function $e(t, e, i) {
        for (var o, n, s, r, a, h, l, u = [1, 4, 2, 8], c = 0, d = t.length; c < d; c++)
            t[c]._code = ei(t[c], e);
        for (s = 0; s < 4; s++) {
            for (h = u[s],
            o = [],
            ...
            n = (d = t.length) - 1; c < d; n = c++)
                ...
                o.push(l)) : (a._code & h && ((l = ti(a, r, h, e, i))._code = ei(l, e),
                o.push(l)),
                o.push(r));
            t = o
        }
    ...
    function Ve(t, e) {
        ...
        oi(t) || (console.warn("latlngs are not flat! Only the first ring will be used"),
        t = t[0]);
        for (var l = N([0, 0]), u = D(t), c = (u.getNorthWest().distanceTo(u.getSouthWest()) * u.getNorthEast().distanceTo(u.getNorthWest()) < 1700 && (l = Ke(t)),
        t.length), d = [], p = 0; p < c; p++) {
            var _ = N(t[p]);
        ...
        N([(u = e.unproject(O(u))).lat + l.lat, u.lng + l.lng])
    }
    function Ke(t) {
        ...
        if (e && t.length) {
            var i = t = function(t, e) {
                for (var i = [t[0]], o = 1, n = 0, s = t.length; o < s; o++)
                    ...
                    )(t[o], t[n]) > e && (i.push(t[o]),
                    n = o);
                return n < s - 1 && i.push(t[s - 1]),
                i
            }(t, e *= e)
              , o = i.length
              , n = new (typeof Uint8Array != void 0 + "" ? Uint8Array : Array)(o);
            n[0] = n[o - 1] = 1,
            function t(e, i, o, n, s) {
                var r, a, h, l = 0;
                for (a = n + 1; a <= s - 1; a++)
                    l < (h = ii(e[a], e[n], e[s], !0)) && (r = a,
                    l = h);
                o < l && (i[r] = 1,
                t(e, i, o, n, r),
                t(e, i, o, r, s))
    ...
    function Xe(t, e, i, o, n) {
        var s, r, a, h = o ? Je : ei(t, i), l = ei(e, i);
        for (Je = l; ; ) {
            if (!(h | l))
                return [t, e];
            if (h & l)
                return !1;
            a = ei(r = ti(t, e, s = h || l, i, n), i),
            s === h ? (t = r,
            h = a) : (e = r,
            l = a)
        }
    ...
    function ti(t, e, i, o, n) {
        ...
        o.min);
        o = o.max;
        return 8 & i ? (s = t.x + a * (o.y - t.y) / e,
        r = o.y) : 4 & i ? (s = t.x + a * (h.y - t.y) / e,
        r = h.y) : 2 & i ? (s = o.x,
        r = t.y + e * (o.x - t.x) / a) : 1 & i && (s = h.x,
        r = t.y + e * (h.x - t.x) / a),
        new k(s,r,n)
    }
    function ei(t, e) {
    ...
    function ii(t, e, i, o) {
        ...
        i.x - n)
          , r = i.y - e
          , a = s * s + r * r;
        return 0 < a && (1 < (a = ((t.x - n) * s + (t.y - e) * r) / a) ? (n = i.x,
        e = i.y) : 0 < a && (n += s * a,
        e += r * a)),
        s = t.x - n,
        r = t.y - e,
    ...
    function si(t, e) {
        ...
        oi(t) || (console.warn("latlngs are not flat! Only the first ring will be used"),
        t = t[0]);
        for (var h = N([0, 0]), l = D(t), u = (l.getNorthWest().distanceTo(l.getSouthWest()) * l.getNorthEast().distanceTo(l.getNorthWest()) < 1700 && (h = Ke(t)),
        ...
        if (0 === i)
            ...
            for (o = d = 0; d < u - 1; d++)
                if (n = c[d],
                s = c[d + 1],
                i < (o += r = n.distanceTo(s))) {
                    a = [s.x - (r = (o - i) / r) * (s.x - n.x), s.y - r * (s.y - n.y)];
                    break
                }
        return N([(l = e.unproject(O(a))).lat + h.lat, l.lng + h.lng])
    }
    it = {
        __proto__: null,
        simplify: Ye,
    ...
    nt = {
        ...
        project: function(t) {
            var e = Math.PI / 180
              ...
              , o = t.lat * e
              , n = this.R_MINOR / i
              , s = (n = Math.sqrt(1 - n * n)) * Math.sin(o);
            s = Math.tan(Math.PI / 4 - o / 2) / Math.pow((1 - s) / (1 + s), n / 2),
            o = -i * Math.log(Math.max(s, 1e-10));
            return new k(t.lng * e * i,o)
        },
        unproject: function(t) {
            for (var e, i = 180 / Math.PI, o = this.R, n = this.R_MINOR / o, s = Math.sqrt(1 - n * n), r = Math.exp(-t.y / o), a = Math.PI / 2 - 2 * Math.atan(r), h = 0, l = .1; h < 15 && 1e-7 < Math.abs(l); h++)
                e = s * Math.sin(a),
                e = Math.pow((1 - e) / (1 + e), s / 2),
                a += l = Math.PI / 2 - 2 * Math.atan(r * e) - a;
            return new F(a * i,t.x * i / o)
        }
    },
    st = {
        __proto__: null,
    ...
    at = e({}, j, {
        code: "EPSG:3395",
        projection: nt,
        transformation: W(rt = .5 / (Math.PI * nt.R), .5, -rt, .5)
    });
    var ri = e({}, j, {
        code: "EPSG:4326",
        projection: ot,
        transformation: W(1 / 180, 1, -1 / 180, .5)
    })
      , ai = (ht = e({}, U, {
        projection: ot,
    ...
    De.include({
        ...
        _updateZoomLevels: function() {
            ...
            for (t in this._zoomBoundLayers) {
                var n = this._zoomBoundLayers[t].options;
                e = void 0 === n.minZoom ? e : Math.min(e, n.minZoom),
                i = void 0 === n.maxZoom ? i : Math.max(i, n.maxZoom)
            }
    ...
    lt.extend({
      ...
      , li = A.extend({
        ...
        _setIconStyles: function(t, e) {
            var i = this.options
              , o = O(o = "number" == typeof (o = i[e + "Size"]) ? [o, o] : o)
      ...
      , ui = li.extend({
        ...
        _getIconUrl: function(t) {
            return "string" != typeof ui.imagePath && (ui.imagePath = this._detectIconPath()),
            (this.options.imagePath || ui.imagePath) + li.prototype._getIconUrl.call(this, t)
        },
      ...
      , ci = X.extend({
        ...
        removeHooks: function() {
            ...
            this._marker._icon && re(this._marker._icon, "leaflet-marker-draggable")
        },
        moved: function() {
        ...
        _adjustPan: function(t) {
            var e = this._marker
              ...
              , r = i.getPixelBounds()
              , a = i.getPixelOrigin();
            (a = B(r.min._subtract(a).add(n), r.max._subtract(a).subtract(n))).contains(s) || (n = O((Math.max(a.max.x, s.x) - a.max.x) / (r.max.x - a.max.x) - (Math.min(a.min.x, s.x) - a.min.x) / (r.min.x - a.min.x), (Math.max(a.max.y, s.y) - a.max.y) / (r.max.y - a.max.y) - (Math.min(a.min.y, s.y) - a.min.y) / (r.min.y - a.min.y)).multiplyBy(o),
            i.panBy(n, {
                animate: !1
            }),
      ...
      , di = lt.extend({
        ...
        _initIcon: function() {
            var t, e = this.options, i = "leaflet-zoom-" + (this._zoomAnimated ? "animated" : "hide"), o = !1, n = !1;
            (t = ((t = e.icon.createIcon(this._icon)) !== this._icon && (this._icon && this._removeIcon(),
            o = !0,
            ...
            e.icon.createShadow(this._shadow))) !== this._shadow && (this._removeShadow(),
            n = !0),
            t && (se(t, i),
            t.alt = ""),
            this._shadow = t,
            ...
            t && n && this.getPane(e.shadowPane).appendChild(this._shadow)
        },
        ...
        _initInteraction: function() {
            var t;
            this.options.interactive && (se(this._icon, "leaflet-interactive"),
        ...
        _panOnFocus: function() {
            var t, e, i = this._map;
            i && (t = (e = this.options.icon.options).iconSize ? O(e.iconSize) : O(0, 0),
      ...
      , mi = _i.extend({
        initialize: function(t, i, o) {
            if (p(this, i = "number" == typeof i ? e({}, o, {
                radius: i
            }) : i),
            this._latlng = N(t),
        ...
        _project: function() {
            var t, e, i, o, n, s = this._latlng.lng, r = this._latlng.lat, a = this._map, h = a.options.crs;
            h.distance === j.distance ? (o = Math.PI / 180,
            n = this._mRadius / j.R / o,
            t = a.project([r + n, s]),
            e = a.project([r - n, s]),
            e = t.add(e).divideBy(2),
            i = a.unproject(e).lat,
            o = Math.acos((Math.cos(n * o) - Math.sin(r * o) * Math.sin(i * o)) / (Math.cos(r * o) * Math.cos(i * o))) / o,
            !isNaN(o) && 0 !== o || (o = n / Math.cos(Math.PI / 180 * r)),
            this._point = e.subtract(a.getPixelOrigin()),
            this._radius = isNaN(o) ? 0 : e.x - a.project([i, s - o]).x,
            this._radiusY = e.y - t.y) : (n = h.unproject(h.project(this._latlng).subtract([this._mRadius, 0])),
            this._point = a.latLngToLayerPoint(this._latlng),
            this._radius = this._point.x - a.latLngToLayerPoint(n).x),
            this._updateBounds()
        }
    })
      , fi = pi.extend({
        ...
        closestLayerPoint: function(t) {
            for (var e = 1 / 0, i = null, o = ii, n = 0, s = this._parts.length; n < s; n++)
                for (var r = this._parts[n], a = 1, h = r.length; a < h; a++) {
                    var l, u, c = o(t, l = r[a - 1], u = r[a], !0);
                    c < e && (e = c,
                    i = o(t, l, u))
                }
        ...
        _projectLatlngs: function(t, e, i) {
            var o, n, s = t[0]instanceof F, r = t.length;
            if (s) {
                for (n = [],
                o = 0; o < r; o++)
        ...
        _clipPoints: function() {
            ...
            this._pxBounds && this._pxBounds.intersects(t))
                if (this.options.noClip)
                    ...
                    for (var e, i, o, n, s = this._parts, r = 0, a = 0, h = this._rings.length; r < h; r++)
                        for (e = 0,
                        i = (n = this._rings[r]).length; e < i - 1; e++)
                            (o = Xe(n[e], n[e + 1], t, e, !0)) && (s[a] = s[a] || [],
                            s[a].push(o[0]),
                            o[1] === n[e + 1] && e !== i - 2 || (s[a].push(o[1]),
                            a++))
        },
        ...
        _containsPoint: function(t, e) {
            var i, o, n, s, r, a, h = this._clickTolerance();
            if (this._pxBounds && this._pxBounds.contains(t))
                for (i = 0,
                s = this._parts.length; i < s; i++)
                    for (o = 0,
                    n = (r = (a = this._parts[i]).length) - 1; o < r; n = o++)
                        if ((e || 0 !== o) && Qe(t, a[n], a[o]) <= h)
                            return !0;
            return !1
        }
    });
    ...
    var gi = fi.extend({
        ...
        getCenter: function() {
            if (this._map)
                return Ve(this._defaultShape(), this._map.options.crs);
            throw new Error("Must add layer to map before using getCenter()")
        },
        _convertLatLngs: function(t) {
            var e = (t = fi.prototype._convertLatLngs.call(this, t)).length;
            return 2 <= e && t[0]instanceof F && t[0].equals(t[e - 1]) && t.pop(),
            t
        },
        _setLatLngs: function(t) {
        ...
        _defaultShape: function() {
            return (oi(this._latlngs[0]) ? this._latlngs : this._latlngs[0])[0]
        },
        _clipPoints: function() {
            var t = this._renderer._bounds
            ...
            this._pxBounds && this._pxBounds.intersects(t))
                if (this.options.noClip)
                    ...
                    for (var i, o = 0, n = this._rings.length; o < n; o++)
                        (i = $e(this._rings[o], t, !0)).length && this._parts.push(i)
        },
        _updatePath: function() {
            this._renderer._updatePoly(this, !0)
        },
        _containsPoint: function(t) {
            var e, i, o, n, s, r, a, h, l = !1;
            if (!this._pxBounds || !this._pxBounds.contains(t))
                return !1;
            for (n = 0,
            a = this._parts.length; n < a; n++)
                for (s = 0,
                r = (h = (e = this._parts[n]).length) - 1; s < h; r = s++)
                    i = e[s],
                    o = e[r],
      ...
      , yi = hi.extend({
        ...
        addData: function(t) {
            ...
            return r.filter && !r.filter(t) || !(s = vi(t, r)) ? this : (s.feature = Si(t),
    ...
    function vi(t, e) {
        var i, o, n, s, r = "Feature" === t.type ? t.geometry : t, a = r ? r.coordinates : null, h = [], l = e && e.pointToLayer, u = e && e.coordsToLatLng || bi;
        if (!a && !r)
            return null;
        switch (r.type) {
        case "Point":
        ...
        case "MultiLineString":
            return o = wi(a, "LineString" === r.type ? 0 : 1, u),
            new fi(o,e);
        case "Polygon":
        case "MultiPolygon":
            return o = wi(a, "Polygon" === r.type ? 1 : 2, u),
            new gi(o,e);
        case "GeometryCollection":
            for (n = 0,
            s = r.geometries.length; n < s; n++) {
                var c = vi({
        ...
        case "FeatureCollection":
            for (n = 0,
            s = r.features.length; n < s; n++) {
                var d = vi(r.features[n], e);
                d && h.push(d)
            }
            return new hi(h);
        default:
    ...
    function xi(t, e, i, o) {
        return t ? t(e, i) : new di(i,o && o.markersInheritOptions && o)
    }
    function bi(t) {
    ...
    function Pi(t, e, i, o) {
        for (var n = [], s = 0, r = t.length; s < r; s++)
            n.push(e ? Pi(t[s], oi(t[s]) ? 0 : e - 1, i, o) : Li(t[s], o));
        return !e && i && 0 < n.length && n.push(n[0].slice()),
        n
    }
    function Ti(t, i) {
    ...
    ai.include({
        ...
        toGeoJSON: function(t) {
            var e, i, o = this.feature && this.feature.geometry && this.feature.geometry.type;
            return "MultiPoint" === o ? this.toMultiPoint(t) : (e = "GeometryCollection" === o,
            i = [],
            this.eachLayer((function(o) {
                o.toGeoJSON && (o = o.toGeoJSON(t),
                e ? i.push(o.geometry) : "FeatureCollection" === (o = Si(o)).type ? i.push.apply(i, o.features) : i.push(o))
            }
            )),
            e ? Ti(this, {
                geometries: i,
    ...
    var Mi = lt.extend({
        ...
        onAdd: function() {
            ...
            this.options.interactive && (se(this._image, "leaflet-interactive"),
        ...
        bringToBack: function() {
            return this._map && oe(this._image),
            this
        },
        setUrl: function(t) {
            return this._url = t,
      ...
      , Ii = lt.extend({
        ...
        initialize: function(t, e) {
            t && (t instanceof F || g(t)) ? (this._latlng = N(t),
            p(this, e)) : (p(this, t),
            this._source = e),
        ...
        onRemove: function(t) {
            t._fadeAnimated ? (le(this._container, 0),
            this._removeTimeout = setTimeout(n(te, void 0, this._container), 200)) : te(this._container),
            this.options.interactive && (re(this._container, "leaflet-interactive"),
        ...
        bringToBack: function() {
            return this._map && oe(this._container),
            this
        },
        _prepareOpen: function(t) {
            if (!(i = this._source)._map)
                return !1;
            if (i instanceof hi) {
                var e, i = null, o = this._source._layers;
                for (e in o)
                    if (o[e]._map) {
                        i = o[e];
                        break
        ...
        _updatePosition: function() {
            ...
            i = this._getAnchor(),
            this._zoomAnimated ? de(this._container, e.add(i)) : t = t.add(e).add(i),
    ...
    Ii.extend({
        ...
        _initLayout: function() {
            ...
            this.options.closeButton && ((i = this._closeButton = Xt("a", t + "-close-button", e)).setAttribute("role", "button"),
            i.setAttribute("aria-label", "Close popup"),
            i.href = "#close",
            i.innerHTML = '<span aria-hidden="true">&#215;</span>',
            xe(i, "click", (function(t) {
                ze(t),
                this.close()
            }
            ), this))
        ...
        _updateLayout: function() {
            ...
            e.whiteSpace = "nowrap",
            t.offsetWidth)
              , o = (i = Math.min(i, this.options.maxWidth),
            ...
            (o && o < i ? (e.height = o + "px",
            se) : re)(t, "leaflet-popup-scrolled"),
        ...
        _adjustPan: function() {
            ...
            e = parseInt(Qt(this._container, "marginBottom"), 10) || 0,
            e = this._container.offsetHeight + e,
            a = this._containerWidth,
            (i = new k(this._containerLeft,-e - this._containerBottom))._add(pe(this._container)),
            i = t.layerPointToContainerPoint(i),
            n = O(this.options.autoPanPadding),
            o = O(this.options.autoPanPaddingTopLeft || n),
            n = O(this.options.autoPanPaddingBottomRight || n),
            s = t.getSize(),
            r = 0,
            i.x + a + n.x > s.x && (r = i.x + a - s.x + n.x),
            i.x - r - o.x < (a = 0) && (r = i.x - o.x),
            i.y + e + n.y > s.y && (a = i.y + e - s.y + n.y),
            i.y - a - o.y < 0 && (a = i.y - o.y),
    ...
    lt.include({
        bindPopup: function(t, e) {
            return this._popup = this._initOverlay(ki, this._popup, t, e),
        ...
        openPopup: function(t) {
            return this._popup && (this instanceof hi || (this._popup._source = this),
        ...
        _openPopup: function(t) {
            var e;
            this._popup && this._map && (Ie(t),
            e = t.layer || t.target,
            this._popup._source !== e || e instanceof pi ? (this._popup._source = e,
    ...
    Ii.extend({
        ...
        _setPosition: function(t) {
            var e, i = this._map, o = this._container, n = i.latLngToContainerPoint(i.getCenter()), s = (i = i.layerPointToContainerPoint(t),
            this.options.direction), r = o.offsetWidth, a = o.offsetHeight, h = O(this.options.offset), l = this._getAnchor();
            i = "top" === s ? (e = r / 2,
            a) : "bottom" === s ? (e = r / 2,
            0) : (e = "center" === s ? r / 2 : "right" === s ? 0 : "left" === s ? r : i.x < n.x ? (s = "right",
            0) : (s = "left",
            r + 2 * (h.x + l.x)),
            a / 2);
            t = t.subtract(O(e, i, !0)).add(h).add(l),
            re(o, "leaflet-tooltip-right"),
            re(o, "leaflet-tooltip-left"),
            re(o, "leaflet-tooltip-top"),
            re(o, "leaflet-tooltip-bottom"),
        ...
        setOpacity: function(t) {
            ...
            this._container && le(this._container, t)
        },
        _animateZoom: function(t) {
            t = this._map._latLngToNewLayerPoint(this._latlng, t.zoom, t.center),
            this._setPosition(t)
    ...
    lt.include({
        ...
        openTooltip: function(t) {
            return this._tooltip && (this instanceof hi || (this._tooltip._source = this),
    ...
    li.extend({
        ...
        createIcon: function(t) {
            ...
            var e = this.options;
            return e.html instanceof Element ? (ee(t),
    ...
    var Zi = lt.extend({
        ...
        _updateOpacity: function() {
            if (this._map && !Mt.ielt9) {
                ...
                var t, e = +new Date, i = !1, o = !1;
                for (t in this._tiles) {
                    var n, s = this._tiles[t];
                    s.current && s.loaded && (n = Math.min(1, (e - s.loaded) / 200),
                    le(s.el, n),
                    n < 1 ? i = !0 : (s.active ? o = !0 : this._onOpaqueTile(s),
                    s.active = !0))
                }
        ...
        _initContainer: function() {
            this._container || (this._container = Xt("div", "leaflet-layer " + (this.options.className || "")),
            this._updateZIndex(),
            this.options.opacity < 1 && this._updateOpacity(),
            this.getPane().appendChild(this._container))
        },
        _updateLevels: function() {
            ...
            if (void 0 !== t) {
                for (var i in this._levels)
                    ...
                    this._onUpdateLevel(i)) : (te(this._levels[i].el),
                    this._removeTilesAtZoom(i),
                    this._onRemoveLevel(i),
                    delete this._levels[i]);
                var o = this._levels[t]
                  , n = this._map;
                return o || ((o = this._levels[t] = {}).el = Xt("div", "leaflet-tile-container leaflet-zoom-animated", this._container),
                o.el.style.zIndex = e,
        ...
        _retainParent: function(t, e, i, o) {
            i -= 1;
            var n = ((n = new k(+(t = Math.floor(t / 2)),+(e = Math.floor(e / 2)))).z = i,
            this._tileCoordsToKey(n));
            return (n = this._tiles[n]) && n.active ? n.retain = !0 : (n && n.loaded && (n.retain = !0),
            o < i && this._retainParent(t, e, i, o))
        },
        _retainChildren: function(t, e, i, o) {
            for (var n = 2 * t; n < 2 * t + 2; n++)
                for (var s = 2 * e; s < 2 * e + 2; s++) {
                    var r = ((r = new k(n,s)).z = i + 1,
        ...
        _setView: function(t, e, i, o) {
            var n = Math.round(e)
              , s = (n = void 0 !== this.options.maxZoom && n > this.options.maxZoom || void 0 !== this.options.minZoom && n < this.options.minZoom ? void 0 : this._clampZoom(n),
            this.options.updateWhenZooming && n !== this._tileZoom);
        ...
        _setZoomTransform: function(t, e, i) {
            ...
            Mt.any3d ? ce(t.el, e, o) : de(t.el, e)
        },
        _resetGrid: function() {
            var t = this._map
              , e = t.options.crs
        ...
        _update: function(t) {
            if (o = this._map) {
                var e = this._clampZoom(o.getZoom());
                if (void 0 === t && (t = o.getCenter()),
                void 0 !== this._tileZoom) {
                    var i, o = this._getTiledPixelBounds(t), n = this._pxBoundsToTileRange(o), s = n.getCenter(), r = [], a = (o = this.options.keepBuffer,
                    new Z(n.getBottomLeft().subtract([o, -o]),n.getTopRight().add([o, -o])));
        ...
        _addTile: function(t, e) {
            ...
            this._initTile(s),
            this.createTile.length < 2 && S(n(this._tileReady, this, t, null, s)),
            de(s, i),
            this._tiles[o] = {
                el: s,
                coords: t,
        ...
        _tileReady: function(t, e, i) {
            ...
            this._map._fadeAnimated ? (le(i.el, 0),
            C(this._fadeFrame),
            this._fadeFrame = S(this._updateOpacity, this)) : (i.active = !0,
            this._pruneTiles()),
            e || (se(i.el, "leaflet-tile-loaded"),
            this.fire("tileload", {
                tile: i.el,
                coords: t
            })),
            ...
            this.fire("load"),
            Mt.ielt9 || !this._map._fadeAnimated ? S(this._pruneTiles, this) : setTimeout(n(this._pruneTiles, this), 250)))
        },
      ...
      , Bi = Zi.extend({
        ...
        initialize: function(t, e) {
            this._url = t,
            (e = p(this, e)).detectRetina && Mt.retina && 0 < e.maxZoom ? (e.tileSize = Math.floor(e.tileSize / 2),
        ...
        createTile: function(t, e) {
            ...
            return xe(i, "load", n(this._tileOnLoad, this, e, i)),
            xe(i, "error", n(this._tileOnError, this, e, i)),
            !this.options.crossOrigin && "" !== this.options.crossOrigin || (i.crossOrigin = !0 === this.options.crossOrigin ? "" : this.options.crossOrigin),
        ...
        _tileOnLoad: function(t, e) {
            Mt.ielt9 ? setTimeout(n(t, this, null, e), 0) : t(null, e)
        },
    ...
    var Di = Bi.extend({
        ...
        initialize: function(t, i) {
            this._url = t;
            var o, n = e({}, this.defaultWmsParams);
            for (o in i)
        ...
        getTileUrl: function(t) {
            var e = this._tileCoordsToNwSe(t)
              , i = (e = (i = B((i = this._crs).project(e[0]), i.project(e[1]))).min,
            i.max);
            e = (1.3 <= this._wmsVersion && this._crs === ri ? [e.y, e.x, i.y, i.x] : [e.x, e.y, i.x, i.y]).join(",");
            return (i = Bi.prototype.getTileUrl.call(this, t)) + _(this.wmsParams, i, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + e
        },
    ...
    var Fi = lt.extend({
        ...
        _updateTransform: function(t, e) {
            ...
            o = o.multiplyBy(-i).add(n).subtract(this._map._getNewPixelOrigin(t, e));
            Mt.any3d ? ce(this._container, o, i) : de(this._container, o)
        },
        _reset: function() {
      ...
      , Ni = Fi.extend({
        ...
        onAdd: function() {
            Fi.prototype.onAdd.call(this),
            this._draw()
        },
        _initContainer: function() {
            var t = this._container = document.createElement("canvas");
            xe(t, "mousemove", this._onMouseMove, this),
            xe(t, "click dblclick mousedown mouseup contextmenu", this._onClick, this),
        ...
        _update: function() {
            var t, e, i, o;
            this._map._animatingZoom && this._bounds || (Fi.prototype._update.call(this),
            t = this._bounds,
            e = this._container,
            i = t.getSize(),
            o = Mt.retina ? 2 : 1,
        ...
        _updateDashArray: function(t) {
            if ("string" == typeof t.options.dashArray) {
                for (var e, i = t.options.dashArray.split(/[, ]+/), o = [], n = 0; n < i.length; n++) {
                    if (e = Number(i[n]),
                    isNaN(e))
                        return;
                    o.push(e)
        ...
        _updatePoly: function(t, e) {
            if (this._drawing) {
                var i, o, n, s, r = t._parts, a = r.length, h = this._ctx;
                if (a) {
                    for (h.beginPath(),
                    i = 0; i < a; i++) {
                        for (o = 0,
        ...
        _updateCircle: function(t) {
            ...
            1 != (n = (Math.max(Math.round(t._radiusY), 1) || o) / o) && (i.save(),
            i.scale(1, n)),
            i.beginPath(),
        ...
        _handleMouseOut: function(t) {
            ...
            e && (re(this._container, "leaflet-interactive"),
        ...
        _handleMouseHover: function(t, e) {
            if (!this._mouseHoverThrottled) {
                ...
                o && (se(this._container, "leaflet-interactive"),
        ...
        _bringToBack: function(t) {
            var e, i, o = t._order;
            o && (e = o.next,
            (i = o.prev) && ((i.next = e) ? e.prev = i : i && (this._drawLast = i),
            o.prev = null,
    ...
    var ji = function() {
      ...
      , Gi = (dt = {
        ...
        _update: function() {
            this._map._animatingZoom || (Fi.prototype._update.call(this),
            this.fire("update"))
        },
        _initPath: function(t) {
        ...
        _updateStyle: function(t) {
            ...
            n.stroked = !!o.stroke,
            n.filled = !!o.fill,
            o.stroke ? (e = e || (t._stroke = ji("stroke")),
            n.appendChild(e),
    ...
    Mt.vml ? ji : V)
      , qi = Fi.extend({
        ...
        _updateCircle: function(t) {
            ...
            e = t._empty() ? "M0 0" : "M" + (e.x - i) + "," + e.y + o + 2 * i + ",0 " + o + 2 * -i + ",0 ";
            this._setPath(t, e)
        },
        _setPath: function(t, e) {
    ...
    qi.create = Gi,
    qi.pointsToPath = K,
    yi.geometryToLayer = vi,
    yi.coordsToLatLng = bi,
    yi.coordsToLatLngs = wi,
    yi.latLngToCoords = Li,
    yi.latLngsToCoords = Pi,
    yi.getFeature = Ti,
    yi.asFeature = Si,
    De.mergeOptions({
        boxZoom: !0
    ...
    J = X.extend({
        ...
        _finish: function() {
            this._moved && (te(this._box),
            re(this._container, "leaflet-crosshair")),
            Wt(),
            me(),
            we(document, {
                contextmenu: Ie,
    ...
    De.addInitHook("addHandler", "boxZoom", J),
    De.mergeOptions({
        doubleClickZoom: !0
    }),
    pt = X.extend({
    ...
    var $i = (De.addInitHook("addHandler", "doubleClickZoom", pt),
    De.mergeOptions({
        dragging: !0,
        inertia: !0,
    ...
    X.extend({
        ...
        _onDragStart: function() {
            var t, e = this._map;
            e._stop(),
            this._map.options.maxBounds && this._map.options.maxBoundsViscosity ? (t = D(this._map.options.maxBounds),
        ...
        _onPreDragWrap: function() {
            var t = this._worldWidth
              ...
              , o = ((n = this._draggable._newPos.x) - e + i) % t + e - i
              , n = (n + e + i) % t - e - i;
        ...
        _onDragEnd: function(t) {
            var e, i, o, n, s = this._map, r = s.options, a = !r.inertia || t.noInertia || this._times.length < 2;
            s.fire("dragend", t),
            ...
            t = t.multiplyBy(i / a),
            o = i / (r.inertiaDeceleration * e),
            (n = t.multiplyBy(-o / 2).round()).x || n.y) ? (n = s._limitOffset(n, s.options.maxBounds),
            S((function() {
                s.panBy(n, {
                    duration: o,
                    easeLinearity: e,
      ...
      , Vi = (_t = (De.addInitHook("addHandler", "dragging", $i),
    De.mergeOptions({
        keyboard: !0,
        keyboardPanDelta: 80
    }),
    X.extend({
        ...
        _setPanDelta: function(t) {
            for (var e = this._panKeys = {}, i = this.keyCodes, o = 0, n = i.left.length; o < n; o++)
                e[i.left[o]] = [-1 * t, 0];
            for (o = 0,
            n = i.right.length; o < n; o++)
                e[i.right[o]] = [t, 0];
            for (o = 0,
            n = i.down.length; o < n; o++)
                e[i.down[o]] = [0, t];
            for (o = 0,
            n = i.up.length; o < n; o++)
                e[i.up[o]] = [0, -1 * t]
        ...
        _setZoomDelta: function(t) {
            for (var e = this._zoomKeys = {}, i = this.keyCodes, o = 0, n = i.zoomIn.length; o < n; o++)
                e[i.zoomIn[o]] = t;
            for (o = 0,
            n = i.zoomOut.length; o < n; o++)
                e[i.zoomOut[o]] = -t
        },
        _addHooks: function() {
        ...
        _onKeyDown: function(t) {
            if (!(t.altKey || t.ctrlKey || t.metaKey)) {
                var e, i, o = t.keyCode, n = this._map;
                if (o in this._panKeys)
                    n._panAnim && n._panAnim._inProgress || (i = this._panKeys[o],
                    t.shiftKey && (i = O(i).multiplyBy(3)),
                    n.options.maxBounds && (i = n._limitOffset(O(i), n.options.maxBounds)),
                    n.options.worldCopyJump ? (e = n.wrapLatLng(n.unproject(n.project(n.getCenter()).add(i))),
                    n.panTo(e)) : n.panBy(i));
                else if (o in this._zoomKeys)
                    n.setZoom(n.getZoom() + (t.shiftKey ? 3 : 1) * this._zoomKeys[o]);
                else {
                    if (27 !== o || !n._popup || !n._popup.options.closeOnEscapeKey)
                        return;
                    n.closePopup()
                }
                Ie(t)
    ...
    mt = (De.addInitHook("addHandler", "keyboard", _t),
    De.mergeOptions({
        scrollWheelZoom: !0,
    ...
    ft = (De.addInitHook("addHandler", "scrollWheelZoom", mt),
    De.mergeOptions({
    ...
    X.extend({
        ...
        _onDown: function(t) {
            ...
            this._holdTimeout = setTimeout(n((function() {
                this._cancel(),
                this._isTapValid() && (xe(document, "touchend", ze),
                xe(document, "touchend touchcancel", this._cancelClickPrevent),
                this._simulateEvent("contextmenu", e))
            }
            ), this), 600),
            xe(document, "touchend touchcancel contextmenu", this._cancel, this),
    ...
    gt = (De.addInitHook("addHandler", "tapHold", ft),
    De.mergeOptions({
        touchZoom: Mt.touch,
    ...
    X.extend({
        ...
        _onTouchStart: function(t) {
            var e, i, o = this._map;
            !t.touches || 2 !== t.touches.length || o._animatingZoom || this._zooming || (e = o.mouseEventToContainerPoint(t.touches[0]),
            ...
            "center" !== o.options.touchZoom && (this._pinchStartLatLng = o.containerPointToLatLng(e.add(i)._divideBy(2))),
...
function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("leaflet")) : "function" == typeof define && define.amd ? define(["exports", "leaflet"], e) : e(((t = "undefined" != typeof globalThis ? globalThis : t || self).L = t.L || {},
    t.L.esri = {}), t.L)
}(this, (function(t, e) {
    "use strict";
    const i = window.XMLHttpRequest && "withCredentials"in new window.XMLHttpRequest
      , o = "" === document.documentElement.style.pointerEvents
      , n = {
        cors: i,
        pointerEvents: o
    }
    ...
    function a(t) {
        ...
        for (const i in t)
            if (Object.hasOwn(t, i)) {
                ...
                let s;
                e.length && (e += "&"),
                s = "[object Array]" === n ? "[object Object]" === Object.prototype.toString.call(o[0]) ? JSON.stringify(o) : o.join(",") : "[object Object]" === n ? JSON.stringify(o) : "[object Date]" === n ? o.valueOf() : o,
    ...
    function h(t, i) {
        ...
        return o.onerror = function() {
            o.onreadystatechange = e.Util.falseFn,
            t.call(i, {
                error: {
                    code: 500,
    ...
    function l(t, e, i, o) {
        const n = h(i, o);
        return n.open("POST", t),
        null != o && void 0 !== o.options && (n.timeout = o.options.timeout),
    ...
    function u(t, e, i, o) {
        const n = h(i, o);
        return n.open("GET", `${t}?${a(e)}`, !0),
        null != o && void 0 !== o.options && (n.timeout = o.options.timeout,
        o.options.withCredentials && (n.withCredentials = !0)),
        n.send(null),
        n
    }
    function c(t, e, i, o) {
        const s = a(e)
          , r = h(i, o)
          , l = `${t}?${s}`.length;
        if (l <= 2e3 && n.cors ? r.open("GET", `${t}?${s}`) : l > 2e3 && n.cors && (r.open("POST", t),
        r.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8")),
        null != o && void 0 !== o.options && (r.timeout = o.options.timeout,
        o.options.withCredentials && (r.withCredentials = !0)),
        l <= 2e3 && n.cors)
            r.send(null);
        else {
            if (!(l > 2e3 && n.cors))
                return l <= 2e3 && !n.cors ? d(t, e, i, o) : void _(`a request to ${t} was longer then 2000 characters and this browser cannot make a cross-domain post request. Please use a proxy https://developers.arcgis.com/esri-leaflet/api-reference/request/`);
            r.send(s)
        }
        return r
    }
    function d(t, i, o, n) {
        ...
        ;
        const h = e.DomUtil.create("script", null, document.body);
        return h.type = "text/javascript",
        h.src = `${t}?${a(i)}`,
        h.id = s,
        h.onerror = function(t) {
            if (t && !0 !== window._EsriLeafletCallbacks[s]) {
                const t = {
                    error: {
                        code: 500,
    ...
    const p = n.cors ? u : d;
    function _(...t) {
        console && console.warn && console.warn.apply(console, t)
    }
    p.CORS = u,
    p.JSONP = d;
    const m = {
  ...
  */
    var f = function(t, e, i, o) {
        var n = (o[0] - i[0]) * (t[1] - i[1]) - (o[1] - i[1]) * (t[0] - i[0])
          , s = (e[0] - t[0]) * (t[1] - i[1]) - (e[1] - t[1]) * (t[0] - i[0])
          , r = (o[1] - i[1]) * (e[0] - t[0]) - (o[0] - i[0]) * (e[1] - t[1]);
        if (0 !== r) {
            var a = n / r
              , h = s / r;
            if (a >= 0 && a <= 1 && h >= 0 && h <= 1)
      ...
      , v = function(t) {
        for (var e, i = 0, o = 0, n = t.length, s = t[o]; o < n - 1; o++)
            i += ((e = t[o + 1])[0] - s[0]) * (e[1] + s[1]),
            s = e;
        return i >= 0
    }
      , x = function(t) {
      ...
      , b = function(t, e) {
        var i = g(t, e)
          , o = function(t, e) {
            for (var i = !1, o = -1, n = t.length, s = n - 1; ++o < n; s = o)
                (t[o][1] <= e[1] && e[1] < t[s][1] || t[s][1] <= e[1] && e[1] < t[o][1]) && e[0] < (t[s][0] - t[o][0]) * (e[1] - t[o][1]) / (t[s][1] - t[o][1]) + t[o][0] && (i = !i);
            return i
        }(t, e[0]);
        return !(i || !o)
    }
      , w = function t(e, i) {
        ...
        if (e.features) {
            ...
            for (var n = 0; n < e.features.length; n++)
                o.features.push(t(e.features[n], i))
        }
        if ("number" == typeof e.x && "number" == typeof e.y && (o.type = "Point",
        o.coordinates = [e.x, e.y],
        "number" == typeof e.z && o.coordinates.push(e.z)),
        e.points && (o.type = "MultiPoint",
        o.coordinates = e.points.slice(0)),
        e.paths && (1 === e.paths.length ? (o.type = "LineString",
        o.coordinates = e.paths[0].slice(0)) : (o.type = "MultiLineString",
        o.coordinates = e.paths.slice(0))),
        e.rings && (o = function(t) {
            for (var e, i, o, n = [], s = [], r = 0; r < t.length; r++) {
                var a = y(t[r].slice(0));
                if (!(a.length < 4))
                    if (v(a)) {
        ...
        "number" == typeof e.xmin && "number" == typeof e.ymin && "number" == typeof e.xmax && "number" == typeof e.ymax && (o.type = "Polygon",
        o.coordinates = [[[e.xmax, e.ymax], [e.xmin, e.ymax], [e.xmin, e.ymin], [e.xmax, e.ymin], [e.xmax, e.ymax]]]),
        (e.geometry || e.attributes) && (o.type = "Feature",
        o.geometry = e.geometry ? t(e.geometry) : null,
        o.properties = e.attributes ? x(e.attributes) : null,
        e.attributes))
            try {
                o.id = function(t, e) {
                    for (var i = e ? [e, "OBJECTID", "FID"] : ["OBJECTID", "FID"], o = 0; o < i.length; o++) {
                        var n = i[o];
                        if (n in t && ("string" == typeof t[n] || "number" == typeof t[n]))
                            return t[n]
                    }
                    throw Error("No valid id attribute found")
                }(e.attributes, i)
            } catch (t) {}
        return JSON.stringify(o.geometry) === JSON.stringify({}) && (o.geometry = null),
      ...
      , P = function t(e, i) {
        ...
        case "MultiPolygon":
            s.rings = function(t) {
                for (var e = [], i = 0; i < t.length; i++)
                    for (var o = L(t[i]), n = o.length - 1; n >= 0; n--) {
                        var s = o[n].slice(0);
                        e.push(s)
                    }
                return e
        ...
        case "FeatureCollection":
            ...
            o = 0; o < e.features.length; o++)
                s.push(t(e.features[o], i));
            break;
        case "GeometryCollection":
            for (s = [],
            o = 0; o < e.geometries.length; o++)
                s.push(t(e.geometries[o], i))
        }
        return s
    };
    function T(t, e) {
    ...
    function C(t) {
        if ("NaN" !== t.xmin && "NaN" !== t.ymin && "NaN" !== t.xmax && "NaN" !== t.ymax) {
            const i = e.latLng(t.ymin, t.xmin)
              , o = e.latLng(t.ymax, t.xmax);
            return e.latLngBounds(i, o)
        }
        return null
    }
    function M(t) {
    ...
    function D(t) {
        if (t.attributionControl) {
            if (t.attributionControl._esriAttributionLayerCount || (t.attributionControl._esriAttributionLayerCount = 0),
            0 === t.attributionControl._esriAttributionLayerCount) {
                if (!t.attributionControl._esriAttributionAddedOnce) {
                    const e = document.createElement("style");
                    e.type = "text/css",
                    e.innerHTML = ".esri-truncated-attribution:hover {white-space: normal;}",
                    document.getElementsByTagName("head")[0].appendChild(e);
                    const i = document.createElement("style");
                    i.type = "text/css",
                    i.innerHTML = `.esri-truncated-attribution {vertical-align: -3px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;display: inline-block;transition: 0s white-space;transition-delay: 1s;max-width: ${R(t)};}`,
                    document.getElementsByTagName("head")[0].appendChild(i),
                    t.on("resize", (e => {
                        t.attributionControl && (t.attributionControl._container.style.maxWidth = R(e.target))
                    }
                    )),
    ...
    function F(t) {
        t.attributionControl && (t.attributionControl._esriAttributionLayerCount && 1 === t.attributionControl._esriAttributionLayerCount && (e.DomUtil.removeClass(t.attributionControl._container, "esri-truncated-attribution:hover"),
    ...
    function N(t) {
        ...
        return t instanceof e.LatLngBounds ? (i.geometry = M(t),
        ...
        "Point" === t.type || "LineString" === t.type || "Polygon" === t.type || "MultiPolygon" === t.type ? (i.geometry = T(t),
        i.geometryType = B(t.type),
        i) : void _("invalid geometry passed to spatial query. Should be L.LatLng, L.LatLngBounds, L.Marker or a GeoJSON Point, Line, Polygon or MultiPolygon object"))
    }
    function U(t, i) {
        n.cors && c(t, {}, e.Util.bind(( (t, o) => {
            if (!t) {
                i._esriAttributions = [];
                for (let t = 0; t < o.contributors.length; t++) {
                    const n = o.contributors[t];
                    for (let t = 0; t < n.coverageAreas.length; t++) {
                        const o = n.coverageAreas[t]
                          , s = e.latLng(o.bbox[0], o.bbox[1])
                          , r = e.latLng(o.bbox[2], o.bbox[3]);
                        i._esriAttributions.push({
                            attribution: n.attribution,
                            score: o.score,
                            bounds: e.latLngBounds(s, r),
                            minZoom: o.zoomMin,
                            maxZoom: o.zoomMax
                        })
                    }
                }
                i._esriAttributions.sort(( (t, e) => e.score - t.score)),
                j({
                    target: i
                })
            }
    ...
    function j(t) {
        const i = t.target
          , o = i._esriAttributions;
        if (!i || !i.attributionControl)
            return;
        const n = i.attributionControl._container.querySelector(".esri-dynamic-attribution");
        if (n && o) {
            let t = "";
            const s = i.getBounds()
              , r = e.latLngBounds(s.getSouthWest().wrap(), s.getNorthEast().wrap())
              , a = i.getZoom();
            for (let e = 0; e < o.length; e++) {
                const i = o[e]
                  , n = i.attribution;
                !t.match(n) && i.bounds.intersects(r) && a >= i.minZoom && a <= i.maxZoom && (t += `, ${n}`)
            }
            t = `Powered by <a href="https://www.esri.com">Esri</a> | ${t.substr(2)}`,
            n.innerHTML = t,
            n.style.maxWidth = R(i),
    ...
    const G = {
        ...
        getEsriAttributionHtmlString: function() {
            return 'Powered by <a href="https://www.esri.com">Esri</a>'
        },
      ...
      , q = e.Class.extend({
        ...
        generateSetter: (t, i) => e.Util.bind((function(e) {
        ...
        initialize(t) {
            ...
            this.options.url = E(t.url)),
            this.params = e.Util.extend({}, this.params || {}),
            this.setters)
                for (const t in this.setters) {
                    const e = this.setters[t];
                    this[t] = this.generateSetter(e, this)
                }
        },
        token(t) {
        ...
        _request(t, e, i, o, n) {
            const s = this.options.proxy ? `${this.options.proxy}?${this.options.url}${e}` : this.options.url + e;
            return "get" !== t && "request" !== t || this.options.useCors ? m[t](s, i, o, n) : m.get.JSONP(s, i, o, n)
        }
    })
      , W = q.extend({
        setters: {
        ...
        simplify(t, e) {
            const i = Math.abs(t.getBounds().getWest() - t.getBounds().getEast());
        ...
        run(t, e) {
            ...
            this.options.isModern || Z(this.options.url) && void 0 === this.options.isModern ? (this.params.f = "geojson",
            this.request((function(i, o) {
                this._trapSQLerrors(i),
                t.call(e, i, o, o)
            }
            ), this)) : this.request((function(i, o) {
                this._trapSQLerrors(i),
                t.call(e, i, o && k(o), o)
            }
            ), this)
        ...
        bounds(t, e) {
            ...
            this.request(( (i, o) => {
                o && o.extent && C(o.extent) ? t.call(e, i, C(o.extent), o) : (i = {
        ...
        run(t, e) {
            return this.request(( (i, o) => {
                if (i)
                    ...
                    const i = k(o);
                    o.results = o.results.reverse();
                    for (let t = 0; t < i.features.length; t++)
                        i.features[t].layerId = o.results[t].layerId;
                    t.call(e, void 0, i, o)
                }
            }
            ))
    ...
    const Q = K.extend({
        ...
        run(t, e) {
            return this.request((function(i, o) {
                t.call(e, i, o && this._responseToGeoJSON(o), o)
            }
            ), this)
        },
        _responseToGeoJSON(t) {
            ...
            if (t.properties && t.properties.Values && (n.pixel.properties.values = t.properties.Values),
            i && i.features && (n.catalogItems = k(i),
            o && o.length === n.catalogItems.features.length))
                for (let t = o.length - 1; t >= 0; t--)
                    n.catalogItems.features[t].properties.catalogItemVisibility = o[t];
            return n
        }
    });
    function X(t) {
    ...
    const tt = e.Evented.extend({
        ...
        initialize(t) {
            ...
            this.options.url = E(this.options.url)
        },
        get(t, e, i, o) {
            return this._request("get", t, e, i, o)
        },
        post(t, e, i, o) {
            return this._request("post", t, e, i, o)
        },
        request(t, e, i, o) {
            return this._request("request", t, e, i, o)
        },
        metadata(t, e) {
        ...
        _request(t, i, o, n, s) {
            ...
            const r = this._createServiceCallback(t, i, o, n, s);
            if (this.options.token && (o.token = this.options.token),
            this.options.requestParams && e.Util.extend(o, this.options.requestParams),
            !this._authenticating) {
                const e = this.options.proxy ? `${this.options.proxy}?${this.options.url}${i}` : this.options.url + i;
                return "get" !== t && "request" !== t || this.options.useCors ? m[t](e, o, r, s) : m.get.JSONP(e, o, r, s)
            }
            this._requestQueue.push([t, i, o, n, s])
        },
        _createServiceCallback(t, i, o, n, s) {
            return e.Util.bind((function(r, a) {
                !r || 499 !== r.code && 498 !== r.code || (this._authenticating = !0,
                this._requestQueue.push([t, i, o, n, s]),
    ...
    const st = tt.extend({
        ...
        addFeatures(t, e, i) {
            const o = t.features ? t.features : [t];
            for (let t = o.length - 1; t >= 0; t--)
                delete o[t].id;
            return t = T(t),
            t = o.length > 1 ? t : [t],
            this.post("addFeatures", {
                ...
                const n = o && o.addResults ? o.addResults.length > 1 ? o.addResults : o.addResults[0] : void 0;
                e && e.call(i, t || o.addResults[0].error, n)
            }
            ), i)
        },
        updateFeature(t, e, i) {
        ...
        updateFeatures(t, e, i) {
            const o = t.features ? t.features : [t];
            return t = T(t, this.options.idAttribute),
            t = o.length > 1 ? t : [t],
            this.post("updateFeatures", {
                features: t
            }, ( (t, o) => {
                const n = o && o.updateResults ? o.updateResults.length > 1 ? o.updateResults : o.updateResults[0] : void 0;
                e && e.call(i, t || o.updateResults[0].error, n)
            }
            ), i)
        },
        deleteFeature(t, e, i) {
        ...
        deleteFeatures(t, e, i) {
            return this.post("deleteFeatures", {
                objectIds: t
            }, ( (t, o) => {
                const n = o && o.deleteResults ? o.deleteResults.length > 1 ? o.deleteResults : o.deleteResults[0] : void 0;
                e && e.call(i, t || o.deleteResults[0].error, n)
            }
            ), i)
        }
    });
    ...
    const at = "https:" !== window.location.protocol ? "http:" : "https:"
      , ht = e.TileLayer.extend({
        ...
        initialize(t, i) {
            ...
            const n = e.Util.extend(o.options, i);
            e.Util.setOptions(this, n),
            this.options.ignoreDeprecationWarning || console.warn("WARNING: L.esri.BasemapLayer uses data services that are in mature support and are not being updated. Please use L.esri.Vector.vectorBasemapLayer instead. More info: https://esriurl.com/esri-leaflet-basemap"),
            this.options.token && -1 === o.urlTemplate.indexOf("token=") && (o.urlTemplate += `?token=${this.options.token}`),
            this.options.proxy && (o.urlTemplate = `${this.options.proxy}?${o.urlTemplate}`),
            e.TileLayer.prototype.initialize.call(this, o.urlTemplate, n)
        },
        onAdd(t) {
            D(t),
            "esri-labels" === this.options.pane && this._initPane(),
            this.options.attributionUrl && U((this.options.proxy ? `${this.options.proxy}?` : "") + this.options.attributionUrl, t),
            t.on("moveend", j),
        ...
        _initPane() {
            if (!this._map.getPane(this.options.pane)) {
                const t = this._map.createPane(this.options.pane);
        ...
        getAttribution() {
            let t;
            return this.options.attribution && (t = `<span class="esri-dynamic-attribution">${this.options.attribution}</span>`),
            t
        }
    })
      , lt = e.TileLayer.extend({
        ...
        initialize(t) {
            (t = e.Util.setOptions(this, t)).apikey && (t.token = t.apikey),
            t = O(t),
        ...
        createTile(t, i) {
            ...
            return e.DomEvent.on(o, "load", e.Util.bind(this._tileOnLoad, this, i, o)),
            e.DomEvent.on(o, "error", e.Util.bind(this._tileOnError, this, i, o)),
            this.options.crossOrigin && (o.crossOrigin = ""),
            o.alt = "",
            !this._lodMap || this._lodMap && void 0 !== this._lodMap[this._getZoomForUrl()] ? o.src = this.getTileUrl(t) : this.once("lodmap", (function() {
        ...
        onAdd(t) {
            D(t),
            this._lodMap || this.metadata((function(i, o) {
                if (!i && o.spatialReference) {
                    const i = o.spatialReference.latestWkid || o.spatialReference.wkid;
                    if (!this.options.attribution && t.attributionControl && o.copyrightText && (this.options.attribution = o.copyrightText,
                    t.attributionControl.addAttribution(this.getAttribution())),
                    t.options.crs !== e.CRS.EPSG3857 || 102100 !== i && 3857 !== i)
                        t.options.crs && t.options.crs.code && t.options.crs.code.indexOf(i) > -1 || _("L.esri.TiledMapLayer is using a non-mercator spatial reference. Support may be available through Proj4Leaflet https://developers.arcgis.com/esri-leaflet/samples/non-mercator-projection/");
                    else {
                        this._lodMap = {};
                        const t = o.tileInfo.lods
                          , e = lt.MercatorZoomLevels;
                        for (let i = 0; i < t.length; i++) {
                            const o = t[i];
                            for (const t in e) {
                                const i = e[t];
                                if (this._withinPercentage(o.resolution, i, this.options.zoomOffsetAllowance)) {
                                    this._lodMap[t] = o.level;
                                    break
                                }
                            }
                        }
        ...
        _withinPercentage: (t, e, i) => Math.abs(t / e - 1) < i
    })
      ...
      , ct = e.Layer.extend({
        ...
        _setAutoZIndex(t) {
            if (!this._currentImage)
                return;
            const e = this._currentImage.getPane().children;
            let i = -t(-1 / 0, 1 / 0);
            for (let o, n = 0, s = e.length; n < s; n++)
                o = e[n].style.zIndex,
                e[n] !== this._currentImage._image && o && (i = t(i, +o));
            ...
            if (this._map) {
                ...
                n = function(t) {
                    ...
                    this._map) {
                        ...
                        o && o._map && o._map.removeLayer(o)) : this._map.removeLayer(i)
                    }
                    this.fire("load", {
                        bounds: e
                    })
        ...
        _update() {
            ...
            if (t > this.options.maxZoom || t < this.options.minZoom)
                return void (this._currentImage && (this._currentImage._map.removeLayer(this._currentImage),
                this._currentImage = null));
            const o = this._buildExportParams();
            e.Util.extend(o, this.options.requestParams),
            o ? (this._requestExport(o, i),
            this.fire("loading", {
                bounds: i
            })) : this._currentImage && (this._currentImage._map.removeLayer(this._currentImage),
            this._currentImage = null)
        },
        _renderPopup(t, i, o, n) {
            if (t = e.latLng(t),
            this._shouldRenderPopup && this._lastClick.equals(t)) {
                const e = this._popupFunction(i, o, n);
                e && this._popup.setLatLng(t).setContent(e).openOn(this._map)
            }
        },
        _resetPopupState(t) {
        ...
        _calculateBbox() {
            const t = this._map.getPixelBounds()
              , i = this._map.unproject(t.getBottomLeft())
              , o = this._map.unproject(t.getTopRight())
              , n = this._map.options.crs.project(o)
        ...
        _calculateImageSize() {
            const t = this._map.getPixelBounds()
              ...
              , i = this._map.unproject(t.getBottomLeft())
              , o = this._map.unproject(t.getTopRight())
              , n = this._map.latLngToLayerPoint(o).y
              , s = this._map.latLngToLayerPoint(i).y;
            return (n > 0 || s < e.y) && (e.y = s - n),
            `${e.x},${e.y}`
        }
    })
      , dt = ct.extend({
        ...
        _getPopupData(t) {
            const i = e.Util.bind((function(i, o, n) {
                i || setTimeout(e.Util.bind((function() {
                    this._renderPopup(t.latlng, i, o, n)
                }
                ), this), 300)
            }
            ), this)
              , o = this.identify().at(t.latlng);
            this.options.mosaicRule && o.setMosaicRule(this.options.mosaicRule),
            o.run(i),
            this._shouldRenderPopup = !0,
            this._lastClick = t.latlng
        },
        _buildExportParams() {
            const t = parseInt(this._map.options.crs.code.split(":")[1], 10)
              , e = {
        ...
        _requestExport(t, i) {
            if ("json" === this.options.f)
                this.service.request("exportImage", t, (function(t, e) {
                ...
                t.f = "image";
                let o = `${this.options.url}exportImage${e.Util.getParamString(t)}`;
                this.options.proxy && (o = `${this.options.proxy}?${o}`),
                this._renderImage(o, i)
            }
        }
    })
      , pt = ct.extend({
        ...
        _getPopupData(t) {
            ...
            let o;
            if (o = this.options.popup ? this.options.popup.on(this._map).at(t.latlng) : this.identify().on(this._map).at(t.latlng),
            o.params.maxAllowableOffset || o.simplify(this._map, .5),
            this.options.popup && this.options.popup.params && this.options.popup.params.layers || (this.options.layers ? o.layers(`visible:${this.options.layers.join(",")}`) : o.layers("visible")),
            this.options.layerDefs && "string" != typeof this.options.layerDefs && !o.params.layerDefs)
                for (const t in this.options.layerDefs)
                    Object.hasOwn(this.options.layerDefs, t) && o.layerDef(t, this.options.layerDefs[t]);
            o.run(i),
            this._shouldRenderPopup = !0,
            this._lastClick = t.latlng
        },
        ...
        _requestExport(t, i) {
            if ("json" === this.options.f)
                this.service.request("export", t, (function(t, e) {
                    t || (this.options.token && e.href && (e.href += `?token=${this.options.token}`),
                ...
                t.f = "image";
                let o = `${this.options.url}export${e.Util.getParamString(t)}`;
                this.options.proxy && (o = `${this.options.proxy}?${o}`),
                this._renderImage(o, i)
            }
        }
      ...
      , _t = e.Layer.extend({
        ...
        redraw() {
            return this._map && (this._removeAllCells(),
            this._update()),
            this
        },
        getEvents() {
        ...
        _pruneCells() {
            ...
            for (t in this._cells)
                ...
                e.current && !e.active) {
                    const t = e.coords;
                    this._retainParent(t.x, t.y, t.z, t.z - 5) || this._retainChildren(t.x, t.y, t.z, t.z + 2)
                }
            for (t in this._cells)
        ...
        _retainParent(t, i, o, n) {
            const s = Math.floor(t / 2)
              , r = Math.floor(i / 2)
              , a = o - 1
              , h = new e.Point(+s,+r);
            h.z = +a;
            const l = this._cellCoordsToKey(h)
              , u = this._cells[l];
            return u && u.active ? (u.retain = !0,
            !0) : (u && u.loaded && (u.retain = !0),
            a > n && this._retainParent(s, r, a, n))
        },
        _retainChildren(t, i, o, n) {
            for (let s = 2 * t; s < 2 * t + 2; s++)
                for (let t = 2 * i; t < 2 * i + 2; t++) {
                    const i = new e.Point(s,t);
                    i.z = o + 1;
                    const r = this._cellCoordsToKey(i)
                      , a = this._cells[r];
                    a && a.active ? a.retain = !0 : (a && a.loaded && (a.retain = !0),
                    o + 1 < n && this._retainChildren(s, t, o + 1, n))
                }
        },
        _resetView(t) {
            const e = t && (t.pinch || t.flyTo);
        ...
        _resetGrid() {
            const t = this._map
              ...
              , o = this._cellZoom
              , n = this._map.getPixelWorldBounds(this._cellZoom);
            n && (this._globalCellRange = this._pxBoundsToCellRange(n)),
            this._wrapX = e.wrapLng && !this.options.noWrap && [Math.floor(t.project([0, e.wrapLng[0]], o).x / i.x), Math.ceil(t.project([0, e.wrapLng[1]], o).x / i.y)],
            this._wrapY = e.wrapLat && !this.options.noWrap && [Math.floor(t.project([e.wrapLat[0], 0], o).y / i.x), Math.ceil(t.project([e.wrapLat[1], 0], o).y / i.y)]
        },
        _onMoveEnd(t) {
        ...
        _getCelldPixelBounds(t) {
            const i = this._map
              , o = i._animatingZoom ? Math.max(i._animateToZoom, i.getZoom()) : i.getZoom()
              , n = i.getZoomScale(o, this._cellZoom)
              , s = i.project(t, this._cellZoom).floor()
              , r = i.getSize().divideBy(2 * n);
        ...
        _update(t) {
            ...
            if (!i)
                return;
            const o = Math.round(i.getZoom());
            void 0 === t && (t = i.getCenter());
            const n = this._getCelldPixelBounds(t)
              , s = this._pxBoundsToCellRange(n)
              , r = s.getCenter()
              , a = []
            ...
            for (const t in this._cells) {
                const i = this._cells[t].coords;
                i.z === this._cellZoom && l.contains(new e.Point(i.x,i.y)) || (this._cells[t].current = !1)
            }
            if (Math.abs(o - this._cellZoom) > 1)
                this._setView(t, o);
            else {
                for (let t = s.min.y; t <= s.max.y; t++)
                    for (let i = s.min.x; i <= s.max.x; i++) {
                        const o = new e.Point(i,t);
                        if (o.z = this._cellZoom,
                        !this._isValidCell(o))
                            continue;
                        const n = this._cells[this._cellCoordsToKey(o)];
                        n ? n.current = !0 : a.push(o)
                    }
                if (a.sort(( (t, e) => t.distanceTo(r) - e.distanceTo(r))),
                0 !== a.length) {
                    this._loading || (this._loading = !0);
                    for (let t = 0; t < a.length; t++) {
                        const e = this._cellCoordsToKey(a[t])
                          , i = this._keyToCellCoords(e);
                        this._activeCells[i] ? this._reuseCell(a[t]) : this._createCell(a[t])
                    }
                }
            }
        },
        _isValidCell(t) {
            ...
            if (!i.infinite) {
                const e = this._globalCellRange;
                if (!i.wrapLng && (t.x < e.min.x || t.x > e.max.x) || !i.wrapLat && (t.y < e.min.y || t.y > e.max.y))
                    return !1
            }
            if (!this.options.bounds)
                return !0;
            const o = this._cellCoordsToBounds(t);
            return e.latLngBounds(this.options.bounds).overlaps(o)
        },
        _keyToBounds(t) {
        ...
        _cellCoordsToBounds(t) {
            const i = this._cellCoordsToNwSe(t);
            let o = new e.LatLngBounds(i[0],i[1]);
            return this.options.noWrap || (o = this._map.wrapLatLngBounds(o)),
            o
        },
        _cellCoordsToKey: t => `${t.x}:${t.y}:${t.z}`,
        _keyToCellCoords(t) {
            const i = t.split(":")
              , o = new e.Point(+i[0],+i[1]);
            return o.z = +i[2],
            o
        },
        _removeCell(t) {
            const e = this._cells[t];
            if (!e)
                return;
            const i = this._keyToCellCoords(t)
              , o = this._wrapCoords(i)
              , n = this._cellCoordsToBounds(this._wrapCoords(i));
            e.current = !1,
            delete this._cells[t],
            this._activeCells[t] = e,
            this.cellLeave(n, o, t),
            this.fire("cellleave", {
                key: t,
                coords: o,
                bounds: n
        ...
        _createCell(t) {
            const i = this._cellCoordsToKey(t)
              , o = this._wrapCoords(t)
              , n = this._cellCoordsToBounds(this._wrapCoords(t));
            this.createCell(n, o, i),
        ...
        _cellReady(t, e, i) {
            const o = this._cellCoordsToKey(t);
            (i = this._cells[o]) && (i.loaded = +new Date,
            i.active = !0)
        },
        _getCellPos(t) {
        ...
        _wrapCoords(t) {
            const i = new e.Point(this._wrapX ? e.Util.wrapNum(t.x, this._wrapX) : t.x,this._wrapY ? e.Util.wrapNum(t.y, this._wrapY) : t.y);
            return i.z = t.z,
            i
        },
        _pxBoundsToCellRange(t) {
            const i = this.getCellSize();
    ...
    mt.prototype.getIndex = function(t) {
        ...
        for (var e, i, o = 0, n = this.values.length - 1; o <= n; )
            if (e = (o + n) / 2 | 0,
    ...
    mt.prototype.between = function(t, e) {
        ...
        for (; this.values[i - 1] && this.values[i - 1].value === t; )
            i--;
        for (; this.values[o + 1] && this.values[o + 1].value === e; )
            o++;
        return this.values[o] && this.values[o].value === e && this.values[o + 1] && o++,
        this.values.slice(i, o)
    }
    ,
    ...
    const ft = _t.extend({
        ...
        initialize(t) {
            if (_t.prototype.initialize.call(this, t),
            t = O(t),
            ...
            "*" !== this.options.fields[0]) {
                let t = !1;
                for (let e = 0; e < this.options.fields.length; e++)
                    this.options.fields[e].match(/^(OBJECTID|FID|OID|ID)$/i) && (t = !0);
                !1 === t && _("no known esriFieldTypeOID field detected in fields Array.  Please add an attribute field containing unique IDs to ensure the layer can be drawn correctly.")
            }
        ...
        onAdd(t) {
            ...
            this.service.metadata((function(e, i) {
                if (!e) {
                    const e = i.supportedQueryFormats;
                    let o = !1;
                    (!1 === this.service.options.isModern || this.options.fetchAllFeatures) && (o = !0),
                    !o && e && -1 !== e.indexOf("geoJSON") && (this.service.options.isModern = !0),
        ...
        _requestFeatures(t, i, o, n) {
            this._activeRequests++,
            n = n || 0;
            const s = this.options.where;
            return 1 === this._activeRequests && this.fire("loading", {
                bounds: t
            }, !0),
            this._buildQuery(t, n).run((function(r, a, h) {
                h && h.exceededTransferLimit && this.fire("drawlimitexceeded"),
                this.options.where === s && (!r && a && a.features.length && e.Util.requestAnimFrame(e.Util.bind((function() {
                ...
                o && o.call(this, r, a),
                h && (h.exceededTransferLimit || h.properties && h.properties.exceededTransferLimit) && this.options.fetchAllFeatures && this._requestFeatures(t, i, o, n + a.features.length))
            }
            ), this)
        },
        _postProcessFeatures(t) {
            this._activeRequests--,
            this._activeRequests <= 0 && this.fire("load", {
                bounds: t
            })
        },
        _cacheKey: t => `${t.z}:${t.x}:${t.y}`,
        _addFeatures(t, e) {
            let i;
            e && (i = this._cacheKey(e),
        ...
        _buildQuery(t, i) {
            let o = this.service.query().intersects(t).where(this.options.where).fields(this.options.fields).precision(this.options.precision);
            return this.options.fetchAllFeatures && !isNaN(parseInt(i)) && (o = o.offset(i)),
            o.params.resultType = "tile",
            this.options.requestParams && e.Util.extend(o.params, this.options.requestParams),
            this.options.simplifyFactor && o.simplify(this._map, this.options.simplifyFactor),
            "server" === this.options.timeFilterMode && this.options.from && this.options.to && o.between(this.options.from, this.options.to),
            o
        },
        setWhere(t, i, o) {
            ...
            let r = 0
              , a = null;
            const h = e.Util.bind((function(h, l) {
                if (h && (a = h),
                l)
                    for (let t = l.features.length - 1; t >= 0; t--)
                        s.push(l.features[t].id);
                r--,
                r <= 0 && this._visibleZoom() && t === this.options.where && (this._currentSnapshot = s,
            ...
            for (let t = this._currentSnapshot.length - 1; t >= 0; t--)
                n.push(this._currentSnapshot[t]);
            this._cache = {};
            for (const t in this._cells) {
                r++;
                const e = this._keyToCellCoords(t)
                  , i = this._cellCoordsToBounds(e);
                this._requestFeatures(i, e, h)
            }
            return this
        },
        getWhere() {
        ...
        setTimeRange(t, i, o, n) {
            const s = this.options.from
              , r = this.options.to;
            let a = 0
              , h = null;
            const l = e.Util.bind((function(e) {
                e && (h = e),
        ...
        _filterExistingFeatures(t, i, o, n) {
            const s = t && i ? this._getFeaturesInTimeRange(t, i) : this._currentSnapshot
              , r = this._getFeaturesInTimeRange(o, n);
            if (r.indexOf)
                for (let t = 0; t < r.length; t++) {
                    const e = s.indexOf(r[t]);
                    e >= 0 && s.splice(e, 1)
                }
            e.Util.requestAnimFrame(e.Util.bind((function() {
                this.removeLayers(s),
        ...
        _getFeaturesInTimeRange(t, e) {
            const i = [];
            let o;
            if (this.options.timeField.start && this.options.timeField.end) {
                const i = this._startTimeIndex.between(t, e)
        ...
        _buildTimeIndexes(t) {
            ...
            if (this.options.timeField.start && this.options.timeField.end) {
                ...
                this._startTimeIndex.bulkAdd(o),
                this._endTimeIndex.bulkAdd(n)
            } else {
                const o = [];
                for (e = t.length - 1; e >= 0; e--)
                    i = t[e],
        ...
        _featureWithinTimeRange(t) {
            if (!this.options.from || !this.options.to)
                return !0;
            const e = +this.options.from.valueOf()
              , i = +this.options.to.valueOf();
            if ("string" == typeof this.options.timeField) {
                const o = +t.properties[this.options.timeField];
                return o >= e && o <= i
            }
            if (this.options.timeField.start && this.options.timeField.end) {
                const o = +t.properties[this.options.timeField.start]
                  , n = +t.properties[this.options.timeField.end];
                return o >= e && o <= i || n >= e && n <= i || o <= e && n >= i
            }
        },
        _visibleZoom() {
            if (!this._map)
        ...
        _getMetadata(t) {
            if (this._metadata) {
                ...
                this.metadata(e.Util.bind((function(e, i) {
                    this._metadata = i,
                    t(e, this._metadata)
                }
                ), this))
        ...
        addFeatures(t, i, o) {
            this._getMetadata(e.Util.bind((function(n, s) {
                if (n)
                    return void (i && i.call(this, n, null));
                const r = t.features ? t.features : [t];
                this.service.addFeatures(t, e.Util.bind((function(t, e) {
                    if (!t) {
                        for (let t = r.length - 1; t >= 0; t--)
                            r[t].properties[s.objectIdField] = r.length > 1 ? e[t].objectId : e.objectId,
                            r[t].id = r.length > 1 ? e[t].objectId : e.objectId;
                        this._addFeatures(r)
                    }
                    i && i.call(o, t, e)
                }
        ...
        updateFeatures(t, e, i) {
            const o = t.features ? t.features : [t];
            this.service.updateFeatures(t, (function(t, n) {
                if (!t) {
                    for (let t = o.length - 1; t >= 0; t--)
                        this.removeLayers([o[t].id], !0);
                    this._addFeatures(o)
                }
                e && e.call(i, t, n)
            }
        ...
        deleteFeatures(t, e, i) {
            return this.service.deleteFeatures(t, (function(t, o) {
                const n = o.length ? o : [o];
                if (!t && n.length > 0)
                    for (let t = n.length - 1; t >= 0; t--)
                        this.removeLayers([n[t].objectId], !0);
                e && e.call(i, t, o)
            }
            ), this)
        }
      ...
      , gt = ft.extend({
        ...
        createNewLayer(t) {
            const i = e.GeoJSON.geometryToLayer(t, this.options);
            return i && (i.defaultOptions = i.options),
            i
        },
        _updateLayer(t, i) {
            let o = [];
            const n = this.options.coordsToLatLng || e.GeoJSON.coordsToLatLng;
            switch (i.properties && (t.feature.properties = i.properties),
            i.geometry.type) {
            case "Point":
                o = e.GeoJSON.coordsToLatLng(i.geometry.coordinates),
                t.setLatLng(o);
                break;
            case "LineString":
                o = e.GeoJSON.coordsToLatLngs(i.geometry.coordinates, 0, n),
                t.setLatLngs(o);
                break;
            case "MultiLineString":
            case "Polygon":
                o = e.GeoJSON.coordsToLatLngs(i.geometry.coordinates, 1, n),
                t.setLatLngs(o);
                break;
            case "MultiPolygon":
                o = e.GeoJSON.coordsToLatLngs(i.geometry.coordinates, 2, n),
                t.setLatLngs(o)
            }
        ...
        createLayers(t) {
            for (let e = t.length - 1; e >= 0; e--) {
                const i = t[e]
                  , o = this._layers[i.id];
                let n;
                !this._visibleZoom() || !o || this._map.hasLayer(o) || this.options.timeField && !this._featureWithinTimeRange(i) || (this._map.addLayer(o),
                this.fire("addfeature", {
                    feature: o.feature
                }, !0)),
                o && (o.setLatLngs || o.setLatLng) && this._updateLayer(o, i),
                o || (n = this.createNewLayer(i),
                n ? (n.feature = i,
                ...
                this._visibleZoom() && (!this.options.timeField || this.options.timeField && this._featureWithinTimeRange(i)) && this._map.addLayer(n)) : _("invalid GeoJSON encountered"))
            }
        },
        addLayers(t) {
            for (let e = t.length - 1; e >= 0; e--) {
                const i = this._layers[t[e]];
        ...
        cellLeave(t, i) {
            this._zooming || e.Util.requestAnimFrame(e.Util.bind((function() {
                if (this._map) {
                    ...
                    if (!this._activeCells[e] && o) {
                        let i = !0;
                        for (let t = 0; t < o.length; t++) {
                            const e = this._layers[o[t]];
                            e && e.getBounds && n.intersects(e.getBounds()) && (i = !1)
                        }
                        i && this.removeLayers(o, !this.options.cacheLayers),
                        !this.options.cacheLayers && i && (delete this._cache[t],
        ...
        resetFeatureStyle(t) {
            const i = this._layers[t]
              , o = this._originalStyle || e.Path.prototype.options;
            return i && (e.Util.extend(i.options, i.defaultOptions),
            this.setFeatureStyle(t, o)),
            this
        },
        setFeatureStyle(t, e) {
            const i = this._layers[t];
        ...
        eachActiveFeature(t, e) {
            if (this._map) {
                const i = this._map.getBounds();
                for (const o in this._layers)
                    -1 !== this._currentSnapshot.indexOf(this._layers[o].feature.id) && ("function" == typeof this._layers[o].getLatLng && i.contains(this._layers[o].getLatLng()) || "function" == typeof this._layers[o].getBounds && i.intersects(this._layers[o].getBounds())) && t.call(e, this._layers[o])
            }
            return this
        },
        eachFeature(t, e) {
        ...
        _redraw(t) {
            ...
            if (i && i.setIcon && this.options.pointToLayer && this.options.pointToLayer) {
                const t = this.options.pointToLayer(o, e.latLng(o.geometry.coordinates[1], o.geometry.coordinates[0])).options.icon;
                i.setIcon(t)
            }
            if (i && i.setStyle && this.options.pointToLayer) {
                const t = this.options.pointToLayer(o, e.latLng(o.geometry.coordinates[1], o.geometry.coordinates[0])).options;
                this.setFeatureStyle(o.id, t)
            }
            i && i.setStyle && this.options.style && this.resetFeatureStyle(o.id)
        },
        openPopup(t) {
            return this._popup && this._popup._prepareOpen(t || this._latlng) && this._popup.openOn(this._map),
            this
        },
        openTooltip(t) {
...
function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("leaflet"), require("esri-leaflet")) : "function" == typeof define && define.amd ? define(["exports", "leaflet", "esri-leaflet"], e) : e(((t = "undefined" != typeof globalThis ? globalThis : t || self).L = t.L || {},
    t.L.esri = t.L.esri || {},
    t.L.esri.Geocoding = {}), t.L, t.L.esri)
}(this, (function(t, e, i) {
    "use strict";
    var o = "https://geocode-api.arcgis.com/arcgis/rest/services/World/GeocodeServer/"
      , n = i.Task.extend({
        ...
        nearby: function(t, i) {
            var o = e.latLng(t);
            return this.params.location = o.lng + "," + o.lat,
            i && (this.params.distance = Math.min(Math.max(i, 2e3), 5e4)),
            this
        },
        run: function(t, e) {
            return this.options.token && (this.params.token = this.options.token),
            this.options.apikey && (this.params.token = this.options.apikey),
            this.options.customParam && (this.params[this.options.customParam] = this.params.singleLine,
            delete this.params.singleLine),
            this.request((function(i, o) {
                var n = this._processGeocoderResponse
                  , s = i ? void 0 : n(o);
                t.call(e, i, {
                    results: s
                }, o)
        ...
        _processGeocoderResponse: function(t) {
            for (var o = [], n = 0; n < t.candidates.length; n++) {
                var s = t.candidates[n];
                if (s.extent)
                    var r = i.Util.extentToBounds(s.extent);
                o.push({
                    text: s.address,
                    bounds: r,
                    score: s.score,
    ...
    var r = i.Task.extend({
        ...
        latlng: function(t) {
            var i = e.latLng(t);
            return this.params.location = i.lng + "," + i.lat,
            this
        },
        run: function(t, i) {
            return this.options.token && (this.params.token = this.options.token),
            this.options.apikey && (this.params.token = this.options.apikey),
            this.request((function(o, n) {
                var s;
                s = o ? void 0 : {
                    latlng: e.latLng(n.location.y, n.location.x),
                    address: n.address
                },
                t.call(i, o, s, n)
            }
    ...
    var h = i.Task.extend({
        ...
        within: function(t) {
            var o = (t = e.latLngBounds(t)).getCenter()
              , n = t.getNorthWest();
            return this.params.location = o.lng + "," + o.lat,
            this.params.distance = Math.min(Math.max(o.distanceTo(n), 2e3), 5e4),
            this.params.searchExtent = i.Util.boundsToExtent(t),
            this
        },
        nearby: function(t, i) {
    ...
    var u = i.Service.extend({
        initialize: function(t) {
            ...
            t.url ? (i.Service.prototype.initialize.call(this, t),
            this._confirmSuggestSupport()) : (t.url = o,
            t.supportsSuggest = !0,
        ...
        _confirmSuggestSupport: function() {
            this.metadata((function(t, e) {
                t || (e.capabilities && e.capabilities.indexOf("Suggest") > -1 ? this.options.supportsSuggest = !0 : this.options.supportsSuggest = !1,
      ...
      , c = e.Evented.extend({
        ...
        initialize: function(t, i) {
            if (e.Util.setOptions(this, i),
            this._control = t,
            !i || !i.providers || !i.providers.length)
                throw new Error("You must specify at least one provider");
            this._providers = i.providers
        },
        _geocode: function(t, i, o) {
            var n, s = 0, r = [], a = e.Util.bind((function(e, i) {
                s--,
                e || (i && (r = r.concat(i)),
                s <= 0 && (n = this._boundsFromResults(r),
                this.fire("results", {
                    results: r,
                    bounds: n,
                    latlng: n ? n.getCenter() : void 0,
                    text: t
                }, !0),
                this.options.zoomToResult && n && this._control._map.fitBounds(n),
                this.fire("load")))
            }
            ), this);
            if (i)
                s++,
                o.results(t, i, this._searchBounds(), a);
            else
                for (var h = 0; h < this._providers.length; h++)
                    s++,
                    this._providers[h].results(t, i, this._searchBounds(), a)
        },
        _suggest: function(t) {
            var i = this._providers.length
              , o = 0
              , n = e.Util.bind((function(t, n) {
                return e.Util.bind((function(e, s) {
                    if (i -= 1,
                    o += s.length,
                    e)
                        return this._control._clearProviderSuggestions(n),
                        void this._control._finalizeSuggestions(i, o);
                    if (s.length)
                        for (var r = 0; r < s.length; r++)
                            s[r].provider = n;
                    else
                        this._control._renderSuggestions(s);
                    n._lastRender !== t && this._control._clearProviderSuggestions(n),
                    s.length && this._control._input.value === t && (n._lastRender = t,
                    this._control._renderSuggestions(s)),
                    this._control._finalizeSuggestions(i, o)
                }
                ), this)
            }
            ), this);
            ...
            for (var s = 0; s < this._providers.length; s++) {
                var r = this._providers[s]
                  , a = r.suggestions(t, this._searchBounds(), n(t, r));
        ...
        _boundsFromResults: function(t) {
            if (t.length) {
                for (var i = e.latLngBounds([0, 0], [0, 0]), o = [], n = [], s = t.length - 1; s >= 0; s--) {
                    var r = t[s];
                    n.push(r.latlng),
                    r.bounds && r.bounds.isValid() && !r.bounds.equals(i) && o.push(r.bounds)
                }
                for (var a = e.latLngBounds(n), h = 0; h < o.length; h++)
                    a.extend(o[h]);
                return a
            }
        },
    ...
    var p = u.extend({
        ...
        suggestions: function(t, e, i) {
            ...
            o.maxSuggestions(this.options.maxResults),
            o.run((function(t, e, o) {
                var n = [];
                if (!t)
                    for (; o.suggestions.length && n.length <= this.options.maxResults - 1; ) {
                        var s = o.suggestions.shift();
                        s.isCollection || n.push({
                            text: s.text,
        ...
        results: function(t, e, i, o) {
            var n = this.geocode().text(t);
            return e && n.key(e),
            n.maxLocations(this.options.maxResults),
            i && n.within(i),
            this.options.forStorage && n.forStorage(!0),
    ...
    var m = e.Control.extend({
        ...
        initialize: function(t) {
            e.Util.setOptions(this, t),
            t && t.providers && t.providers.length || (t || (t = {}),
            t.providers = [_()]),
        ...
        _renderSuggestions: function(t) {
            ...
            for (var s = [], r = 0; r < t.length; r++) {
                var a = t[r];
                if (!n && this._geosearchCore._providers.length > 1 && i !== a.provider.options.label && ((n = e.DomUtil.create("div", "geocoder-control-header", a.provider._contentsElement)).textContent = a.provider.options.label,
                n.innerText = a.provider.options.label,
                i = a.provider.options.label),
                o || (o = e.DomUtil.create("ul", "geocoder-control-list", a.provider._contentsElement)),
                -1 === s.indexOf(a.text)) {
                    var h = e.DomUtil.create("li", "geocoder-control-suggestion", o);
                    h.innerHTML = a.text,
                    ...
                    for (var l = 0; l < o.childNodes.length; l++)
                        o.childNodes[l].innerHTML === a.text && (o.childNodes[l]["data-magic-key"] += "," + a.magicKey);
                s.push(a.text)
            }
        ...
        clear: function() {
            ...
            this.options.collapseAfterResult && (this._input.value = "",
            this._lastValue = "",
        ...
        _finalizeSuggestions: function(t, i) {
            t || (e.DomUtil.removeClass(this._input, "geocoder-control-loading"),
            this.getPosition().indexOf("bottom") > -1 && this._setSuggestionsBottomPosition(),
        ...
        geocodeSuggestion: function(t) {
            ...
            e.classList.contains("geocoder-control-suggestions") || e.classList.contains("geocoder-control-header") || (e.classList.length < 1 && (e = e.parentNode),
        ...
        onAdd: function(t) {
            ...
            this.options.expanded && (e.DomUtil.addClass(this._wrapper, "geocoder-control-expanded"),
            this._input.placeholder = this.options.placeholder),
            this._suggestions = e.DomUtil.create("div", "geocoder-control-suggestions leaflet-bar", this._wrapper);
            for (var o = 0; o < this.options.providers.length; o++)
                this.options.providers[o]._contentsElement = e.DomUtil.create("div", null, this._suggestions);
            var n = this._geosearchCore._getAttribution();
            return t.attributionControl && t.attributionControl.addAttribution(n),
            e.DomEvent.addListener(this._input, "focus", (function(t) {
                this._input.placeholder = this.options.placeholder,
                e.DomUtil.addClass(this._wrapper, "geocoder-control-expanded")
            }
            ), this),
            ...
            e.DomEvent.addListener(this._input, "blur", (function(t) {
                this.clear()
            }
            ), this),
            e.DomEvent.addListener(this._input, "keydown", (function(t) {
                var i = (t.target || t.srcElement).value;
                e.DomUtil.addClass(this._wrapper, "geocoder-control-expanded");
                for (var o, n = this._suggestions.querySelectorAll(".geocoder-control-suggestion"), s = this._suggestions.querySelectorAll(".geocoder-control-selected")[0], r = 0; r < n.length; r++)
                    if (n[r] === s) {
                        o = r;
                        break
                    }
                ...
                case 13:
                    ...
                    this.clear()) : this.options.allowMultipleResults && i.length >= 2 ? (this._geosearchCore._geocode(this._input.value, void 0),
                    this.clear()) : 1 === n.length ? (e.DomUtil.addClass(n[0], "geocoder-control-selected"),
                    this._geosearchCore._geocode(n[0].innerHTML, n[0]["data-magic-key"], n[0].provider)) : (this.clear(),
                    this._input.blur()),
                ...
                case 38:
                    ...
                    var a = n[o - 1];
                    s && a ? e.DomUtil.addClass(a, "geocoder-control-selected") : e.DomUtil.addClass(n[n.length - 1], "geocoder-control-selected"),
                    e.DomEvent.preventDefault(t);
                    break;
                case 40:
                    s && e.DomUtil.removeClass(s, "geocoder-control-selected");
                    var h = n[o + 1];
                    s && h ? e.DomUtil.addClass(h, "geocoder-control-selected") : e.DomUtil.addClass(n[0], "geocoder-control-selected"),
                    e.DomEvent.preventDefault(t);
                    break;
                default:
            ...
            e.DomEvent.addListener(this._input, "keyup", e.Util.throttle((function(t) {
                var i = t.which || t.keyCode
                  , o = (t.target || t.srcElement).value;
                if (o.length < 2)
                    return this._lastValue = this._input.value,
                    this._clearAllSuggestions(),
                    void e.DomUtil.removeClass(this._input, "geocoder-control-loading");
                27 !== i ? 13 !== i && 38 !== i && 40 !== i && this._input.value !== this._lastValue && (this._lastValue = this._input.value,
                e.DomUtil.addClass(this._input, "geocoder-control-loading"),
                this._geosearchCore._suggest(o)) : this._clearAllSuggestions()
            }
            ), 50, this), this),
      ...
      , f = i.FeatureLayerService.extend({
        ...
        suggestions: function(t, e, i) {
            var o = this._suggestionsQuery.where(this._buildQuery(t)).returnGeometry(!1);
            return e && o.intersects(e),
            this.options.idField && o.fields([this.options.idField].concat(this.options.searchFields)),
            o.run((function(t, e, o) {
                if (t)
                    i(t, []);
                else {
                    this.options.idField = o.objectIdFieldName;
                    for (var n = [], s = e.features.length - 1; s >= 0; s--) {
                        var r = e.features[s];
                        n.push({
                    ...
                    i(t, n.slice(0, this.options.maxResults))
                }
            }
            ), this)
        },
        results: function(t, i, o, n) {
            var s = this._resultsQuery;
            return i ? (delete s.params.where,
            s.featureIds([i])) : s.where(this._buildQuery(t)),
            o && s.within(o),
            s.run(e.Util.bind((function(t, e) {
                for (var i = [], o = 0; o < e.features.length; o++) {
                    var s = e.features[o];
                    if (s) {
        ...
        _buildQuery: function(t) {
            for (var e = [], i = this.options.searchFields.length - 1; i >= 0; i--) {
                var o = 'upper("' + this.options.searchFields[i] + '")';
                if ("contain" === this.options.searchMode)
                    e.push(o + " LIKE upper('%" + t + "%')");
        ...
        _featureBounds: function(t) {
            ...
            if ("Point" === t.geometry.type) {
                var o = i.getBounds().getCenter()
                  , n = this.options.bufferRadius / 40075017 * 360 / Math.cos(180 / Math.PI * o.lat)
                  , s = this.options.bufferRadius / 40075017 * 360;
                return e.latLngBounds([o.lat - s, o.lng - n], [o.lat + s, o.lng + n])
            }
            return i.getBounds()
        }
    })
      , g = i.MapService.extend({
        ...
        suggestions: function(t, e, i) {
            return this.find().text(t).fields(this.options.searchFields).returnGeometry(!1).layers(this.options.layers).run((function(t, e, o) {
                var n = [];
                if (!t) {
        ...
        results: function(t, e, i, o) {
            ...
            if (e && !e.includes(",")) {
                var r = e.split(":")[0]
                  , a = e.split(":")[1];
                n = this.query().layer(a).featureIds(r)
            } else
                n = this.find().text(t).fields(this.options.searchFields).layers(this.options.layers);
            return n.run((function(t, e, i) {
                if (!t) {
                    i.results && (i.results = i.results.reverse());
                    for (var n = 0; n < e.features.length; n++) {
                        var r = e.features[n];
                        if (a = a || i.results[n].layerId,
                        r && void 0 !== a) {
        ...
        _layerMetadataCallback: function(t) {
            return e.Util.bind((function(e, i) {
                if (!e) {
                    ...
                    for (var o = 0; o < i.fields.length; o++) {
                        var n = i.fields[o];
                        if ("esriFieldTypeOID" === n.type) {
                            this._idFields[t] = n.name;
                            break
                        }
                    }
                }
