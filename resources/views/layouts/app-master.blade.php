                ...
                <div id="kt_app_hero" class="app-hero  pt-6 pb-7 border-bottom border-gray-300 ">
                    <div id="kt_app_hero_container" class="app-container  container-fluid ">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="kt_search_rent" role="tabpanel">
                                <div class="d-flex flex-wrap gap-5">
                                    <div class="w-lg-175px">
                                        <label for="proveedor" class="form-label">Proveedor</label>
                                        <select id="proveedor" class="form-select form-select-solid border" data-control="select2" data-placeholder="Select" data-hide-search="true">
                                    ...
                                    <div class="w-lg-175px">
                                        ...
                                        <select id="tipo" class="form-select form-select-solid border" data-control="select2" data-placeholder="Select" data-hide-search="true">
                                        </select>
                                    </div>

                                    <div class="w-lg-175px">
                                        <label for="vehicle" class="form-label">Vehículo</label>
                                        <select id="vehicle" onchange="getVehicleInfo(this)" class="form-select form-select-solid border" data-control="select2" data-placeholder="Select" data-hide-search="true"></select>
                                    </div>
                                    <div  style="align-content: end;">
                                        <button id="handlerClickSearch" class="btn btn-dark">
                                            Buscar
                                        </button>
                        ...
                        <div class="app-container container-fluid d-flex flex-row-fluid " style="padding-left: 0px !important; padding-right: 0px !important;">
                            <!--begin::Main-->
